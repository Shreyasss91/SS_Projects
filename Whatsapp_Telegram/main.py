...
# Place here: Before main and before custom module imports
load_dotenv()


from bot_database import init_db
from bot_market import WebSocketManager, QuoteService, OptionChainService
from bot_alerts import AlertEngine
