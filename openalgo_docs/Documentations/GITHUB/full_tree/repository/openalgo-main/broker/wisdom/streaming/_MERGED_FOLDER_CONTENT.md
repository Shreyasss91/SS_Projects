...
Folder: C:\Users\admin\Desktop\openalgo_docs\GITHUB\full_tree\repository\openalgo-main\broker\wisdom\streaming



---

# FILE: broker\wisdom\streaming\__init__.py
...
# FILE: broker\wisdom\streaming\wisdom_adapter.py
...
# FILE: broker\wisdom\streaming\wisdom_mapping.py
...
class WisdomExchangeMapper:
    ...
    # Reverse mapping for converting Wisdom exchange codes to OpenAlgo format
    # Format: {Wisdom_Exchange_Code: OpenAlgo_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert OpenAlgo exchange code to Wisdom XTS specific exchange type
...
# FILE: broker\wisdom\streaming\wisdom_websocket.py
...
class WisdomWebSocketClient:
    ...
    def connect(self):
        ...
        try:
            ...
            self.logger.debug(f"Connecting to Wisdom XTS Socket.IO: {connection_url}")
    ...
    def disconnect(self):
        ...
        try:
            if self.sio and self.sio.connected:
                self.sio.disconnect()
                self.logger.debug("Socket.IO client disconnected")
        except Exception as e:
        ...
        self.logger.debug("Disconnected from Wisdom XTS Socket.IO")
