...
in the same spirit as ``Documents/evidence/openalgo_platform/OPENALGO_PATCH.md``.
...
Related documentation
  Documents/evidence/openalgo_platform/OPENALGO_PATCH.md   (the channel-spread patch this probes)
