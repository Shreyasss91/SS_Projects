...
- **FYERS TBT patch is mandatory for 50-level — but it does not buy a full chain.** Without
  `Documents/evidence/openalgo_fyers_tbt_channels.patch` applied to OpenAlgo (and OpenAlgo restarted),
  ...
  **~15 legs at 50-level**: FYERS caps Market-Depth at **5 symbols per _connection_** (3 connections per
  ...
  ceiling 250" wording is disproven; see `Documents/evidence/tbt_concurrency_reconciliation_20260714.md`.
