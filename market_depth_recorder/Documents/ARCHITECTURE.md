...
patch (`Documents/evidence/openalgo_platform/OPENALGO_PATCH.md`), **B** dated storage inside the package, **C** the
...
full record is `Documents/evidence/depth_transition_20260826/depth_transition_probe_20260826.md` with six evidence JSONs
alongside it.
...
`Documents/evidence/depth_transition_20260826/depth_transition_probe_runbook_20260826.md`. F8 has not started.
