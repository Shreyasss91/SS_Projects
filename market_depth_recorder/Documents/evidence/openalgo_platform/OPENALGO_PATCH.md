...
`Documents/evidence/openalgo_platform/openalgo_fyers_tbt_channels.patch` (regenerated 2026-08-25 after the comment-block
...
git apply strategies/SS_Projects/market_depth_recorder/Documents/evidence/openalgo_platform/openalgo_fyers_tbt_channels.patch
...
**Upgrade drift (important):** `Documents/evidence/openalgo_platform/openalgo_fyers_tbt_channels.patch` is the source of
...
`Documents/evidence/fyers_tbt_concurrency_20260714/tbt_concurrency_reconciliation_20260714.md` (canonical).
