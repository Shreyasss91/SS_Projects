...
| Broker Adapter (`BrokerAdapter`, wire rendering + dispatch + delivery-derived snapshot) | F7.5 | **Built.** F7A prepared and **F7B measured 2026-08-26** — the contract is now derived from live evidence in `Documents/evidence/depth_transition_20260826/depth_transition_probe_20260826.md` §19: promotion subscribes `SYMBOL:50`, demotion unsubscribes it, and no in-place depth edit exists. Implemented in F7.5 as its own approved phase — F7 itself is complete as the evidence phase; Plan_002 §20.1, §22.8, §22.9 |
...
after a reconnect. Full record: `Documents/evidence/depth_transition_20260826/depth_transition_probe_20260826.md` §16-§19.
...
(`Documents/evidence/depth_transition_20260826/depth_transition_probe_20260826.md` §16-§19).
