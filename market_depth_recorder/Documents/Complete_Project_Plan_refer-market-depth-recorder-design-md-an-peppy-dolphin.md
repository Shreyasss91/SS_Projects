...
- `Documents/patches/tbt_concurrency_reconciliation_20260714.md` — canonical evidence
- `Documents/patches/OPENALGO_PATCH.md` section 8 — the authoritative correction
