...
- Chartink URL: https://chartink.com/screener/volume-burst-15-mins-test
- Scan ID: `5272812`
...
- Raw snapshot: [source-snapshots/5272812.json](../source-snapshots/5272812.json)
- Text snapshot: [source-snapshots/5272812.txt](../source-snapshots/5272812.txt)
...
Scan id: 5272812
Slug: volume-burst-15-mins-test
Source URL: https://chartink.com/screener/volume-burst-15-mins-test
...
3. [Disabled] daily volume > 2 days ago sma( close ,  7 ) * 10
4. [Disabled] [0] 15 minute volume > [-2] 15 minute sma( close ,  7 ) * 15
5. [Disabled] daily count( 4, 1 where daily % change < 0.5 ) > 3
6. [Disabled] [0] 15 minute volume > [-2] 15 minute sma( close ,  7 ) * 10
...
- **#8** `daily stddva( close ,  20 ) < 5` — Inequality test: left expression must be strictly less than right.
...
### Disabled #3
- **Condition (verbatim):** `daily volume > 2 days ago sma( close ,  7 ) * 10`
...
### Disabled #4
- **Condition (verbatim):** `[0] 15 minute volume > [-2] 15 minute sma( close ,  7 ) * 15`
