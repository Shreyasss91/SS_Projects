...
scan_id: 18099671
scan_name: gap down
source_url: https://chartink.com/screener/gap-down-31074378
...
- Chartink URL: https://chartink.com/screener/gap-down-31074378
- Scan ID: `18099671`
- Slug: `gap-down-31074378`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2024-09-01T15:10:54.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/18099671.json](../source-snapshots/18099671.json)
- Text snapshot: [source-snapshots/18099671.txt](../source-snapshots/18099671.txt)

## What this scan is for

This scan, titled "gap down", appears designed to screen Indian equities in the **futures** universe using **1 enabled** condition(s) combined with root join **all (AND)**.
...
Scan id: 18099671
Slug: gap-down-31074378
Source URL: https://chartink.com/screener/gap-down-31074378
Root universe/segment: futures
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2024-09-01T15:10:54.000000Z

=== Condition tree (from atlas_json; includes Enabled and Disabled) ===

1. [Enabled] daily open < 1 day ago close * 0.98

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( futures ( latest open < 1 day ago close * 0.98 ) )
```
...
|---:|---|---|---|
| 1 | Enabled | daily open < 1 day ago close * 0.98 | Inequality test: left expression must be strictly less than right. |
...
- **#1** `daily open < 1 day ago close * 0.98` — Inequality test: left expression must be strictly less than right.
