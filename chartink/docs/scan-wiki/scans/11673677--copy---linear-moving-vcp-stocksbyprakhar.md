...
source_url: https://chartink.com/screener/copy-linear-moving-vcp-atstocksbyprakhar-157
...
- Chartink URL: https://chartink.com/screener/copy-linear-moving-vcp-atstocksbyprakhar-157
- Scan ID: `11673677`
- Slug: `copy-linear-moving-vcp-atstocksbyprakhar-157`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-05-07T03:29:20.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/11673677.json](../source-snapshots/11673677.json)
- Text snapshot: [source-snapshots/11673677.txt](../source-snapshots/11673677.txt)
...
Scan id: 11673677
Slug: copy-linear-moving-vcp-atstocksbyprakhar-157
Source URL: https://chartink.com/screener/copy-linear-moving-vcp-atstocksbyprakhar-157
Root universe/segment: cash
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2023-05-07T03:29:20.000000Z
...
3. [Enabled] ( daily close - daily sma( close ,  50 ) / daily sma( close ,  50 ) ) < 0.16
4. [Enabled] daily sma( close,50 ) > daily sma( close,150 )
5. [Enabled] daily close > daily sma( close,150 )
6. [Enabled] daily close > daily sma( close,200 )
7. [Enabled] daily sma( close,150 ) > daily sma( close,200 )
...
- **#1** `daily count( 200, 1 where daily close > 1 day ago close * 1 ) >= 100` — Inequality test: left expression must be strictly greater than right.
...
- **#3** `( daily close - daily sma( close ,  50 ) / daily sma( close ,  50 ) ) < 0.16` — Inequality test: left expression must be strictly less than right. SMA is the arithmetic mean of the chosen field over N bars.
- **#4** `daily sma( close,50 ) > daily sma( close,150 )` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars.
- **#5** `daily close > daily sma( close,150 )` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars.
...
- **#7** `daily sma( close,150 ) > daily sma( close,200 )` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars.
...
- **Method context:** Fundamental, Moving average, Volume/delivery, Multi-factor.
