---
scan_id: 14009476
scan_name: Retest old high after long time intraday 30MIN FNO _LESS LOOKBACK_More signals
source_url: https://chartink.com/screener/retest-old-high-after-long-time-intraday-30min-fno-less-lookback-more-signals
...
# Retest old high after long time intraday 30MIN FNO _LESS LOOKBACK_More signals

## Source

- Chartink URL: https://chartink.com/screener/retest-old-high-after-long-time-intraday-30min-fno-less-lookback-more-signals
- Scan ID: `14009476`
- Slug: `retest-old-high-after-long-time-intraday-30min-fno-less-lookback-more-signals`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2023-11-30T14:40:06.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/14009476.json](../source-snapshots/14009476.json)
- Text snapshot: [source-snapshots/14009476.txt](../source-snapshots/14009476.txt)

## What this scan is for

This scan, titled "Retest old high after long time intraday 30MIN FNO _LESS LOOKBACK_More signals", appears designed to screen Indian equities in the **futures** universe using **3 enabled** condition(s) combined with root join **all (AND)**.
...
```text
Scan name: Retest old high after long time intraday 30MIN FNO _LESS LOOKBACK_More signals
Scan id: 14009476
Slug: retest-old-high-after-long-time-intraday-30min-fno-less-lookback-more-signals
Source URL: https://chartink.com/screener/retest-old-high-after-long-time-intraday-30min-fno-less-lookback-more-signals
Root universe/segment: futures
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2023-11-30T14:40:06.000000Z
...
4. [Disabled] [-1] 30 minute max( 249 ,  [0] 30 minute close ) < [-250] 30 minute max( 250 ,  [0] 30 minute close )

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( futures ( 1 day ago close * 1 day ago volume > 100000000 and latest count( 200, 1 where( latest high / latest low ) = 1 ) < 1 and [0] 30 minute high > [-1] 30 minute max( 249 , [0] 30 minute close ) and [ -1 ] 30 minute high <= [ -2 ] 30 minute max( 249 , [0] 30 minute close ) ) )
```
...
### Disabled #4
- **Condition (verbatim):** `[-1] 30 minute max( 249 ,  [0] 30 minute close ) < [-250] 30 minute max( 250 ,  [0] 30 minute close )`
