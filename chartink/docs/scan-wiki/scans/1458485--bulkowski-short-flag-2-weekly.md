...
tags: ["bias:upward-condition", "universe:nifty-200", "indicator:volume", "indicator:sma", "timeframe:daily", "timeframe:weekly"]
...
- Chartink URL: https://chartink.com/screener/copy-bulkowski-short-flag-2-3
- Scan ID: `1458485`
- Slug: `copy-bulkowski-short-flag-2-3`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2019-11-27T14:38:34.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/1458485.json](../source-snapshots/1458485.json)
- Text snapshot: [source-snapshots/1458485.txt](../source-snapshots/1458485.txt)
...
Scan id: 1458485
Slug: copy-bulkowski-short-flag-2-3
Source URL: https://chartink.com/screener/copy-bulkowski-short-flag-2-3
...
3. [Enabled] weekly close > 5 weeks ago close
    group_path: root/group[nifty 200|all]
4. [Enabled] 5 weeks ago close > 27 weeks ago close * 1.22
    group_path: root/group[nifty 200|all]
...
- **#1** `weekly volume > weekly sma( volume,10 ) * 1.2` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Volume condition gates participation/liquidity. References weekly bars / weekly offset.
- **#3** `weekly close > 5 weeks ago close` — Inequality test: left expression must be strictly greater than right. References weekly bars / weekly offset.
- **#4** `5 weeks ago close > 27 weeks ago close * 1.22` — Inequality test: left expression must be strictly greater than right.
- **#5** `weekly close > weekly sma( close,15 )` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. References weekly bars / weekly offset.
...
- Timeframe tokens: `0_days_ago`, `0_weeks_ago`, `27_weeks_ago`, `5_weeks_ago`
