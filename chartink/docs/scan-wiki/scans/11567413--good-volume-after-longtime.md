...
- Chartink URL: https://chartink.com/screener/good-volume-after-longtime
- Scan ID: `11567413`
- Slug: `good-volume-after-longtime`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-04-24T18:47:49.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/11567413.json](../source-snapshots/11567413.json)
- Text snapshot: [source-snapshots/11567413.txt](../source-snapshots/11567413.txt)
...
Scan id: 11567413
Slug: good-volume-after-longtime
Source URL: https://chartink.com/screener/good-volume-after-longtime
...
3. [Enabled] 1 day ago count( 20, 1 where daily volume < daily sma( close ,  20 ) ) >= 15
    group_path: root/group[cash|all]
...
- **#2** `daily volume > 1 day ago sma( close ,  20 ) * 2` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Volume condition gates participation/liquidity.
- **#3** `1 day ago count( 20, 1 where daily volume < daily sma( close ,  20 ) ) >= 15` — Inequality test: left expression must be strictly less than right. SMA is the arithmetic mean of the chosen field over N bars. Volume condition gates participation/liquidity.
- **#4** `daily abs( daily close - daily open ) / ( daily high - daily low ) > 0.5` — Inequality test: left expression must be strictly greater than right.
