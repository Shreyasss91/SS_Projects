---
scan_id: 2637175
scan_name: Murrey Math Oscillator BUY
source_url: https://chartink.com/screener/murrey-math-oscillator-buy
market: Indian equities
horizon: Swing
classification: ["Other"]
tags: ["long-bias", "universe:cash", "timeframe:daily"]
...
# Murrey Math Oscillator BUY

## Source

- Chartink URL: https://chartink.com/screener/murrey-math-oscillator-buy
- Scan ID: `2637175`
- Slug: `murrey-math-oscillator-buy`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2020-08-01T04:20:29.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/2637175.json](../source-snapshots/2637175.json)
- Text snapshot: [source-snapshots/2637175.txt](../source-snapshots/2637175.txt)

## What this scan is for

This scan, titled "Murrey Math Oscillator BUY", appears designed to screen Indian equities in the **cash** universe using **2 enabled** condition(s) combined with root join **all (AND)**.
...
```text
Scan name: Murrey Math Oscillator BUY
Scan id: 2637175
Slug: murrey-math-oscillator-buy
Source URL: https://chartink.com/screener/murrey-math-oscillator-buy
Root universe/segment: cash
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2020-08-01T04:20:29.000000Z
...
4. [Enabled] ( daily close - daily min( 100 ,  daily low ) + ( ( ( daily max( 100 ,  daily high ) - daily min( 100 ,  daily low ) ) * 0.125 ) * 4 ) ) / ( ( daily max( 100 ,  daily high ) - daily min( 100 ,  daily low ) ) / 2 ) < 1.01

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( cash ( 1 day ago "close *  volume" > 1000000000 and( latest close - latest min( 100 , latest low ) + ( ( ( latest max( 100 , latest high ) - latest min( 100 , latest low ) ) * 0.125 ) * 4 ) ) / ( ( latest max( 100 , latest high ) - latest min( 100 , latest low ) ) / 2 ) < 1.01 ) )
```
...
| 4 | Enabled | ( daily close - daily min( 100 ,  daily low ) + ( ( ( daily max( 100 ,  daily high ) - daily min( 100 ,  daily low ) ) * 0.125 ) * 4 ) ) / ( ( daily max( 100 ,  daily high ) - daily min( 100 ,  daily low ) ) / 2 ) < 1.01 | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars. |
...
- **#4** `( daily close - daily min( 100 ,  daily low ) + ( ( ( daily max( 100 ,  daily high ) - daily min( 100 ,  daily low ) ) * 0.125 ) * 4 ) ) / ( ( daily max( 100 ,  daily high ) - daily min( 100 ,  daily low ) ) / 2 ) < 1.01` — Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars.
