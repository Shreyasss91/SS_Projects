...
tags: ["long-bias", "universe:nifty-200", "timeframe:monthly", "timeframe:daily"]
...
This scan, titled "cross prev month low and face buying and close above that low", appears designed to screen Indian equities in the **nifty 200** universe using **3 enabled** condition(s) combined with root join **all (AND)**.
...
| 2 | Enabled | 2 days ago low < 1 month ago low | Inequality test: left expression must be strictly less than right. References monthly bars / monthly offset. |
| 3 | Enabled | 1 day ago high > 1 month ago low | Inequality test: left expression must be strictly greater than right. References monthly bars / monthly offset. |
| 4 | Enabled | daily close > 1 month ago low | Inequality test: left expression must be strictly greater than right. References monthly bars / monthly offset. |
