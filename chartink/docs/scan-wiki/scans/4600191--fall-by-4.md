...
scan_id: 4600191
scan_name: "Fall by 4%"
source_url: https://chartink.com/screener/del-5143
...
- Chartink URL: https://chartink.com/screener/del-5143
- Scan ID: `4600191`
- Slug: `del-5143`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2021-05-19T03:05:27.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/4600191.json](../source-snapshots/4600191.json)
- Text snapshot: [source-snapshots/4600191.txt](../source-snapshots/4600191.txt)

## What this scan is for

This scan, titled "Fall by 4%", appears designed to screen Indian equities in the **futures** universe using **3 enabled** condition(s) combined with root join **all (AND)**.
...
Author description (source metadata): To use with PnF(5 mins) + CMF on PnF, Renko(5 mins), OHLC(60 mins)
...
Scan id: 4600191
Slug: del-5143
Source URL: https://chartink.com/screener/del-5143
Root universe/segment: futures
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2021-05-19T03:05:27.000000Z

=== Condition tree (from atlas_json; includes Enabled and Disabled) ===

1. [Enabled] 1 day ago close * 1 day ago volume > 100000000
2. [Disabled] daily % change < -4
3. [Disabled] daily % change > 10
4. [Disabled] daily volume > 1 day ago volume * 3
5. [Enabled] daily close > 1 day ago high
6. [Enabled] ( 1 day ago max( 10 ,  daily close ) - 1 day ago min( 10 ,  daily close ) ) / daily close < 0.05

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( futures ( 1 day ago close * 1 day ago volume > 100000000 and latest close > 1 day ago high and( 1 day ago max( 10 , latest close ) - 1 day ago min( 10 , latest close ) ) / latest close < 0.05 ) )
```
...
| 2 | Disabled | daily % change < -4 | Inequality test: left expression must be strictly less than right. Currently disabled in source — not applied when the scan runs. |
| 3 | Disabled | daily % change > 10 | Inequality test: left expression must be strictly greater than right. Currently disabled in source — not applied when the scan runs. |
| 4 | Disabled | daily volume > 1 day ago volume * 3 | Inequality test: left expression must be strictly greater than right. Currently disabled in source — not applied when the scan runs. Volume condition gates participation/liquidity. |
| 5 | Enabled | daily close > 1 day ago high | Inequality test: left expression must be strictly greater than right. |
| 6 | Enabled | ( 1 day ago max( 10 ,  daily close ) - 1 day ago min( 10 ,  daily close ) ) / daily close < 0.05 | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars. |
...
- **#6** `( 1 day ago max( 10 ,  daily close ) - 1 day ago min( 10 ,  daily close ) ) / daily close < 0.05` — Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars.
...
### Disabled #4
- **Condition (verbatim):** `daily volume > 1 day ago volume * 3`
