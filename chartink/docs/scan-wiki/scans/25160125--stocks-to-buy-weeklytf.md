...
horizon: Swing
classification: ["Fundamental", "Moving average", "Oscillator", "Volatility", "Volume/delivery", "Breakout", "Momentum", "Trend following", "Multi-factor"]
tags: ["bias:upward-condition", "bias:downward-condition", "universe:cash", "indicator:rsi", "indicator:ichimoku", "indicator:atr", "indicator:volume", "timeframe:daily", "timeframe:weekly"]
...
Its method labels are derived only from active expressions: **Fundamental, Moving average, Oscillator, Volatility, Volume/delivery, Breakout, Momentum, Trend following, Multi-factor**.
...
- **Method context:** Fundamental, Moving average, Oscillator, Volatility, Volume/delivery, Breakout, Momentum, Trend following, Multi-factor.
...
- **Horizon:** Swing
- **Methods:** Fundamental, Moving average, Oscillator, Volatility, Volume/delivery, Breakout, Momentum, Trend following, Multi-factor
- **Tags:** bias:upward-condition, bias:downward-condition, universe:cash, indicator:rsi, indicator:ichimoku, indicator:atr, indicator:volume, timeframe:daily, timeframe:weekly
- **Root universe:** cash
- **Root join:** all
