...
|---:|---:|---|---|---|---|
| 1 | 1 | Enabled | root | daily abs( daily open - daily close ) > 1 day ago sma( close ,  10 ) * 4 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. |
