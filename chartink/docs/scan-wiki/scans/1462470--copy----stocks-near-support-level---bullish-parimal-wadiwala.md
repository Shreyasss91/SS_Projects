...
- Chartink URL: https://chartink.com/screener/copy-stocks-near-support-level-bullish-parimal-wadiwala-eod
- Scan ID: `1462470`
...
- Raw snapshot: [source-snapshots/1462470.json](../source-snapshots/1462470.json)
- Text snapshot: [source-snapshots/1462470.txt](../source-snapshots/1462470.txt)
...
Scan id: 1462470
Slug: copy-stocks-near-support-level-bullish-parimal-wadiwala-eod
Source URL: https://chartink.com/screener/copy-stocks-near-support-level-bullish-parimal-wadiwala-eod
...
- **#2** `daily close crossed below 1 day ago min( 200 ,  daily low )` — Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). min(N, series) is the lowest value of series over N bars.
- **#3** `daily close crossed below 1 day ago min( 600 ,  daily low )` — Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). min(N, series) is the lowest value of series over N bars.
