...
classification: ["Volatility", "Breakout", "Momentum", "Multi-factor"]
tags: ["bias:upward-condition", "universe:cash", "indicator:atr", "timeframe:daily", "timeframe:monthly", "timeframe:weekly"]
...
- Chartink URL: https://chartink.com/screener/monthly-weekly-test-2
- Scan ID: `13928838`
- Slug: `monthly-weekly-test-2`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Multi-horizon
- Created at (Chartink): 2023-11-24T04:50:56.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/13928838.json](../source-snapshots/13928838.json)
- Text snapshot: [source-snapshots/13928838.txt](../source-snapshots/13928838.txt)

## What this scan is for

This is a **multi-horizon** screen over **cash** with **4** active leaf condition(s) under root join **all (AND)**.
Its method labels are derived only from active expressions: **Volatility, Breakout, Momentum, Multi-factor**.
...
Scan id: 13928838
Slug: monthly-weekly-test-2
Source URL: https://chartink.com/screener/monthly-weekly-test-2
...
- **#2** `monthly close crossed above 1 month ago max( 100 ,  monthly high )` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars. References monthly bars / monthly offset.
- **#3** `monthly % change > 30` — Inequality test: left expression must be strictly greater than right. References monthly bars / monthly offset.
- **#5** `weekly avg true range( 1 ) / 1 week ago avg true range( 14 ) > 5` — Inequality test: left expression must be strictly greater than right. ATR measures smoothed true range (volatility), not direction. References weekly bars / weekly offset.
- **#6** `weekly high = weekly max( 20 ,  weekly high )` — Equality test between left and right expressions. max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset.
...
- Timeframe tokens: `0_days_ago`, `0_months_ago`, `0_weeks_ago`, `1_months_ago`, `1_weeks_ago`
...
- **Method context:** Volatility, Breakout, Momentum, Multi-factor.
...
- **Horizon:** Multi-horizon
- **Methods:** Volatility, Breakout, Momentum, Multi-factor
- **Tags:** bias:upward-condition, universe:cash, indicator:atr, timeframe:daily, timeframe:monthly, timeframe:weekly
- **Root universe:** cash
- **Root join:** all
