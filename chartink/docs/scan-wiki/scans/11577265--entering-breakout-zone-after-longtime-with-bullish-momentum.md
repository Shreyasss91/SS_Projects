...
tags: ["bias:upward-condition", "bias:downward-condition", "universe:futures", "indicator:aroon", "timeframe:daily"]
...
- Chartink URL: https://chartink.com/screener/breakout-2023-04-25-7
- Scan ID: `11577265`
- Slug: `breakout-2023-04-25-7`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-04-25T18:23:04.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/11577265.json](../source-snapshots/11577265.json)
- Text snapshot: [source-snapshots/11577265.txt](../source-snapshots/11577265.txt)
...
Scan id: 11577265
Slug: breakout-2023-04-25-7
Source URL: https://chartink.com/screener/breakout-2023-04-25-7
...
- **#1** `daily close / 1 day ago max( 100 ,  daily high ) > 0.95` — Inequality test: left expression must be strictly greater than right. max(N, series) is the highest value of series over N bars.
- **#2** `daily close / 1 day ago max( 100 ,  daily high ) < 1` — Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars.
- **#3** `daily max( 5 ,  daily high ) crossed above 1 day ago max( 5 ,  daily high )` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars.
- **#4** `1 day ago aroon up( 100 ) < 50` — Inequality test: left expression must be strictly less than right.
