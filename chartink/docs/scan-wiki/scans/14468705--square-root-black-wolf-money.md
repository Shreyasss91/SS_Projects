...
tags: ["bias:upward-condition", "universe:nifty-200", "indicator:volume", "indicator:ema", "timeframe:daily", "timeframe:intraday-bars"]
...
- daily square root( daily abs( [0] 15 minute ema( close ,  30 ) - [0] 15 minute ema( close ,  30 ) ) ) crossed above 800
