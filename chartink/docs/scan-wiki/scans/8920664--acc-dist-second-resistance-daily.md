...
This scan, titled "acc dist second resistance daily", appears designed to screen Indian equities in the **nifty 500** universe using **4 enabled** condition(s) combined with root join **any (OR)**.
