...
# Virgin Pivot on Downside

## Source

- Chartink URL: https://chartink.com/screener/virgin-pivot-9
- Scan ID: `24507997`
- Slug: `virgin-pivot-9`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2025-11-17T04:28:12.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/24507997.json](../source-snapshots/24507997.json)
- Text snapshot: [source-snapshots/24507997.txt](../source-snapshots/24507997.txt)
...
Scan id: 24507997
Slug: virgin-pivot-9
Source URL: https://chartink.com/screener/virgin-pivot-9
...
3. [Enabled] daily low crossed below 1 day ago pivot point
    group_path: root/group[cash|all]
4. [Enabled] [GROUP segment=cash join=all combination=passes measurevalue=default]  (path: root/group[cash|all])
5. [Enabled] 2 days ago low > 2 days ago pivot point
    group_path: root/group[cash|all]
6. [Enabled] 1 day ago low > 2 days ago pivot point
    group_path: root/group[cash|all]
7. [Enabled] daily low crossed below 2 days ago pivot point
    group_path: root/group[cash|all]
8. [Enabled] [GROUP segment=cash join=all combination=passes measurevalue=default]  (path: root/group[cash|all])
9. [Enabled] 3 days ago low > 3 days ago pivot point
    group_path: root/group[cash|all]
10. [Enabled] 2 days ago low > 3 days ago pivot point
    group_path: root/group[cash|all]
11. [Enabled] 1 day ago low > 3 days ago pivot point
    group_path: root/group[cash|all]
...
- **#2** `1 day ago low > 1 day ago pivot point` — Inequality test: left expression must be strictly greater than right. Pivot fields are classic floor-trader support/resistance levels from prior period H/L/C.
- **#3** `daily low crossed below 1 day ago pivot point` — Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Pivot fields are classic floor-trader support/resistance levels from prior period H/L/C.
- **#5** `2 days ago low > 2 days ago pivot point` — Inequality test: left expression must be strictly greater than right. Pivot fields are classic floor-trader support/resistance levels from prior period H/L/C.
- **#6** `1 day ago low > 2 days ago pivot point` — Inequality test: left expression must be strictly greater than right. Pivot fields are classic floor-trader support/resistance levels from prior period H/L/C.
- **#7** `daily low crossed below 2 days ago pivot point` — Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Pivot fields are classic floor-trader support/resistance levels from prior period H/L/C.
- **#9** `3 days ago low > 3 days ago pivot point` — Inequality test: left expression must be strictly greater than right. Pivot fields are classic floor-trader support/resistance levels from prior period H/L/C.
- **#10** `2 days ago low > 3 days ago pivot point` — Inequality test: left expression must be strictly greater than right. Pivot fields are classic floor-trader support/resistance levels from prior period H/L/C.
- **#11** `1 day ago low > 3 days ago pivot point` — Inequality test: left expression must be strictly greater than right. Pivot fields are classic floor-trader support/resistance levels from prior period H/L/C.
- **#12** `daily low crossed below 3 days ago pivot point` — Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Pivot fields are classic floor-trader support/resistance levels from prior period H/L/C.
