...
# MFI OSCILLATION AND EXTREME

## Source

- Chartink URL: https://chartink.com/screener/mfi-oscillation-and-extreme
- Scan ID: `24419121`
- Slug: `mfi-oscillation-and-extreme`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2025-11-08T13:43:19.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/24419121.json](../source-snapshots/24419121.json)
- Text snapshot: [source-snapshots/24419121.txt](../source-snapshots/24419121.txt)
...
Scan id: 24419121
Slug: mfi-oscillation-and-extreme
Source URL: https://chartink.com/screener/mfi-oscillation-and-extreme
...
4. [Enabled] [0] 30 minute sum( close ,  89 ) crossed above 25
...
- **#2** `[0] 30 minute min( 233 ,  [0] 30 minute mfi( 89 ) ) crossed above 45` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). min(N, series) is the lowest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#4** `[0] 30 minute sum( close ,  89 ) crossed above 25` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data.
...
### Disabled #5
- **Condition (verbatim):** `[0] 30 minute sum( close ,  89 ) crossed below -25`
