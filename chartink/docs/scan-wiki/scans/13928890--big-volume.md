---
scan_id: 13928890
scan_name: big volume
source_url: https://chartink.com/screener/big-volume-5000005
...
- Chartink URL: https://chartink.com/screener/big-volume-5000005
- Scan ID: `13928890`
- Slug: `big-volume-5000005`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-11-24T04:56:30.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/13928890.json](../source-snapshots/13928890.json)
- Text snapshot: [source-snapshots/13928890.txt](../source-snapshots/13928890.txt)

## What this scan is for

This scan, titled "big volume", appears designed to screen Indian equities in the **cash** universe using **4 enabled** condition(s) combined with root join **all (AND)**.
...
```text
Scan name: big volume
Scan id: 13928890
Slug: big-volume-5000005
Source URL: https://chartink.com/screener/big-volume-5000005
Root universe/segment: cash
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2023-11-24T04:56:30.000000Z
...
4. [Enabled] daily close > 50
    group_path: root/group[cash|all]
5. [Enabled] daily sma( close ,  3 ) > 3 days ago sma( close ,  21 ) * 20

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( cash ( ( cash ( 1 day ago close * 1 day ago volume > 100000000 and( latest avg true range( 7 ) / latest sma( latest close , 7 ) ) * 100 > 3 and latest close > 50 ) ) and latest sma( latest volume , 3 ) > 3 days ago sma( latest volume , 21 ) * 20 ) )
```
...
| 5 | Enabled | daily sma( close ,  3 ) > 3 days ago sma( close ,  21 ) * 20 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. |
...
- **#5** `daily sma( close ,  3 ) > 3 days ago sma( close ,  21 ) * 20` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars.
