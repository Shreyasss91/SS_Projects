...
- daily close > 50
- daily sma( close ,  3 ) > 3 days ago sma( close ,  21 ) * 20
...
| 4 | 5 | Enabled | root | daily sma( close ,  3 ) > 3 days ago sma( close ,  21 ) * 20 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. |
