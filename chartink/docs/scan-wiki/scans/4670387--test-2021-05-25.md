---
scan_id: 4670387
scan_name: test 2021-05-25
source_url: https://chartink.com/screener/test-2021-05-25-15
...
- Chartink URL: https://chartink.com/screener/test-2021-05-25-15
- Scan ID: `4670387`
- Slug: `test-2021-05-25-15`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2021-05-25T06:29:09.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/4670387.json](../source-snapshots/4670387.json)
- Text snapshot: [source-snapshots/4670387.txt](../source-snapshots/4670387.txt)
...
- daily count( 3, 1 where ( daily max( 20 ,  daily high ) - daily min( 20 ,  daily low ) ) < ( 21 days ago max( 20 ,  daily high ) - 21 days ago min( 20 ,  daily low ) ) * 0.4 ) > 1
- 1 day ago close * 1 day ago volume > 100000000
- daily count( 200, 1 where ( daily high / daily low ) = 1 ) < 1
- daily count( 10, 1 where ( daily max( 10 ,  daily high ) - daily min( 10 ,  daily low ) ) < ( 11 days ago max( 10 ,  daily high ) - 11 days ago min( 10 ,  daily low ) ) * 0.4 ) > 6
...
```text
Scan name: test 2021-05-25
Scan id: 4670387
Slug: test-2021-05-25-15
Source URL: https://chartink.com/screener/test-2021-05-25-15
Root universe/segment: futures
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2021-05-25T06:29:09.000000Z
...
3. [Enabled] daily count( 200, 1 where ( daily high / daily low ) = 1 ) < 1
    group_path: root/group[cash|all]
4. [Enabled] daily count( 3, 1 where ( daily max( 20 ,  daily high ) - daily min( 20 ,  daily low ) ) < ( 21 days ago max( 20 ,  daily high ) - 21 days ago min( 20 ,  daily low ) ) * 0.4 ) > 1
    group_path: root/group[cash|all]
...
6. [Enabled] 1 day ago close * 1 day ago volume > 100000000
    group_path: root/group[cash|all]
7. [Enabled] daily count( 200, 1 where ( daily high / daily low ) = 1 ) < 1
    group_path: root/group[cash|all]
8. [Enabled] daily count( 10, 1 where ( daily max( 10 ,  daily high ) - daily min( 10 ,  daily low ) ) < ( 11 days ago max( 10 ,  daily high ) - 11 days ago min( 10 ,  daily low ) ) * 0.4 ) > 6
    group_path: root/group[cash|all]

=== Literal Chartink atlas_query (compiled active query; typically omits disabled filters) ===

( futures ( ( cash ( 1 day ago close * 1 day ago volume > 100000000 and latest count( 200, 1 where( latest high / latest low ) = 1 ) < 1 and latest count( 10, 1 where( latest max( 10 , latest high ) - latest min( 10 , latest low ) ) < ( 11 days ago max( 10 , latest high ) - 11 days ago min( 10 , latest low ) ) * 0.4 ) > 6 ) ) ) )
```
...
| 3 | 4 | Enabled | root/group[cash\|all] | daily count( 3, 1 where ( daily max( 20 ,  daily high ) - daily min( 20 ,  daily low ) ) < ( 21 days ago max( 20 ,  daily high ) - 21 days ago min( 20 ,  daily low ) ) * 0.4 ) > 1 | Inequality test: left expression must be strictly greater than right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars. |
...
| 5 | 7 | Enabled | root/group[cash\|all] | daily count( 200, 1 where ( daily high / daily low ) = 1 ) < 1 | Inequality test: left expression must be strictly less than right. |
| 6 | 8 | Enabled | root/group[cash\|all] | daily count( 10, 1 where ( daily max( 10 ,  daily high ) - daily min( 10 ,  daily low ) ) < ( 11 days ago max( 10 ,  daily high ) - 11 days ago min( 10 ,  daily low ) ) * 0.4 ) > 6 | Inequality test: left expression must be strictly greater than right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars. |
...
- **#7** `daily count( 200, 1 where ( daily high / daily low ) = 1 ) < 1` — Inequality test: left expression must be strictly less than right.
- **#8** `daily count( 10, 1 where ( daily max( 10 ,  daily high ) - daily min( 10 ,  daily low ) ) < ( 11 days ago max( 10 ,  daily high ) - 11 days ago min( 10 ,  daily low ) ) * 0.4 ) > 6` — Inequality test: left expression must be strictly greater than right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars.
...
- Timeframe tokens: `0_days_ago`, `11_days_ago`, `1_days_ago`, `21_days_ago`
