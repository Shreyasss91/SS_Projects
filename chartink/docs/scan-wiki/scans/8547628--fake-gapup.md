...
| 2 | 2 | Enabled | root | daily open > 1 day ago close | Inequality test: left expression must be strictly greater than right. |
| 3 | 3 | Enabled | root | [0] 5 minute count( 360, 1 where [0] 5 minute close < [-1] 5 minute close ) > 200 | Inequality test: left expression must be strictly greater than right. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
