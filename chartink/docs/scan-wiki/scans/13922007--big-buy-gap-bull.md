...
- Chartink URL: https://chartink.com/screener/big-buy-73
- Scan ID: `13922007`
- Slug: `big-buy-73`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-11-23T13:46:13.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/13922007.json](../source-snapshots/13922007.json)
- Text snapshot: [source-snapshots/13922007.txt](../source-snapshots/13922007.txt)
...
Scan id: 13922007
Slug: big-buy-73
Source URL: https://chartink.com/screener/big-buy-73
...
3. [Enabled] daily close > daily open
4. [Enabled] daily volume > 2 days ago sma( close ,  7 ) * 10
...
7. [Enabled] ( daily avg true range( 7 ) / daily sma( close ,  7 ) ) * 100 > 3
    group_path: root/group[cash|all]
...
- **#1** `daily close > 1 day ago close * 1.05` — Inequality test: left expression must be strictly greater than right.
- **#2** `daily open > 1 day ago close * 1.01` — Inequality test: left expression must be strictly greater than right.
- **#3** `daily close > daily open` — Inequality test: left expression must be strictly greater than right.
- **#4** `daily volume > 2 days ago sma( close ,  7 ) * 10` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Volume condition gates participation/liquidity.
...
- **#7** `( daily avg true range( 7 ) / daily sma( close ,  7 ) ) * 100 > 3` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. ATR measures smoothed true range (volatility), not direction.
- **#8** `daily close > 50` — Inequality test: left expression must be strictly greater than right.
...
- **Method context:** Breakout, Moving average, Volatility, Volume/delivery, Multi-factor.
