...
# good intraday movement stocks

## Source

- Chartink URL: https://chartink.com/screener/good-intraday-movement-stocks
- Scan ID: `11540903`
- Slug: `good-intraday-movement-stocks`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2023-04-21T10:27:43.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/11540903.json](../source-snapshots/11540903.json)
- Text snapshot: [source-snapshots/11540903.txt](../source-snapshots/11540903.txt)

## What this scan is for

This scan, titled "good intraday movement stocks", appears designed to screen Indian equities in the **nifty 100** universe using **1 enabled** condition(s) combined with root join **all (AND)**.
...
```text
Scan name: good intraday movement stocks
Scan id: 11540903
Slug: good-intraday-movement-stocks
Source URL: https://chartink.com/screener/good-intraday-movement-stocks
Root universe/segment: nifty 100
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2023-04-21T10:27:43.000000Z

=== Condition tree (from atlas_json; includes Enabled and Disabled) ===

1. [Enabled] daily sma( close ,  4 ) > 3

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( nifty 100 ( latest sma( latest avg true range( 14 ) / latest close * 100 , 4 ) > 3 ) )
```
...
|---:|---|---|---|
| 1 | Enabled | daily sma( close ,  4 ) > 3 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. |
...
- **#1** `daily sma( close ,  4 ) > 3` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars.
