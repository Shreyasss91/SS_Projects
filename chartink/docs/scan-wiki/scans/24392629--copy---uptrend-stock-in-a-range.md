...
tags: ["bias:upward-condition", "universe:cash", "indicator:volume", "indicator:ema", "timeframe:daily", "timeframe:weekly"]
...
# Copy - Uptrend stock in a range

## Source

- Chartink URL: https://chartink.com/screener/copy-uptrend-stock-in-a-range-83
- Scan ID: `24392629`
- Slug: `copy-uptrend-stock-in-a-range-83`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2025-11-06T00:26:46.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/24392629.json](../source-snapshots/24392629.json)
- Text snapshot: [source-snapshots/24392629.txt](../source-snapshots/24392629.txt)
...
Scan id: 24392629
Slug: copy-uptrend-stock-in-a-range-83
Source URL: https://chartink.com/screener/copy-uptrend-stock-in-a-range-83
...
3. [Enabled] weekly ema( weekly close ,  21 ) > 5 weeks ago ema( weekly close ,  21 )
4. [Enabled] daily close / 1 day ago close - 1 <= 0.045
...
- **#1** `0 quarters ago foreign institutional investors percentage > 1 quarters ago foreign institutional investors percentage` — Inequality test: left expression must be strictly greater than right.
- **#2** `weekly close > weekly ema( weekly close ,  21 )` — Inequality test: left expression must be strictly greater than right. EMA is an exponentially weighted moving average of the chosen field. References weekly bars / weekly offset.
- **#3** `weekly ema( weekly close ,  21 ) > 5 weeks ago ema( weekly close ,  21 )` — Inequality test: left expression must be strictly greater than right. EMA is an exponentially weighted moving average of the chosen field. References weekly bars / weekly offset.
- **#4** `daily close / 1 day ago close - 1 <= 0.045` — Inequality test: left expression must be less than or equal to right.
- **#5** `daily close / 1 day ago close - 1 >= -0.045` — Inequality test: left expression must be greater than or equal to right.
- **#6** `daily volume > 20 days ago volume * 2` — Inequality test: left expression must be strictly greater than right. Volume condition gates participation/liquidity.
...
- Timeframe tokens: `0_days_ago`, `0_quarters_ago`, `0_weeks_ago`, `1_days_ago`, `1_quarters_ago`, `20_days_ago`, `5_weeks_ago`
