...
- daily count( 15, 1 where daily open > 1 day ago close ) crossed above 10
...
| 2 | 2 | Enabled | root | daily count( 15, 1 where daily open > 1 day ago close ) crossed above 10 | Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). |
