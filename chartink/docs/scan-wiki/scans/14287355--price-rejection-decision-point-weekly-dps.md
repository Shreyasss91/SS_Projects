...
tags: ["universe:nifty-200","indicator:volume","indicator:sma","timeframe:daily","timeframe:weekly","timeframe:intraday-bars"]
...
This is a **multi-horizon** screen over **nifty 200** with **15** active leaf condition(s) under root join **all**.
