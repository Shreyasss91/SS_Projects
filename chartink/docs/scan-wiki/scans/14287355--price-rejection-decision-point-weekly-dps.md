...
tags: ["bias:upward-condition", "bias:downward-condition", "universe:nifty-200", "indicator:atr", "indicator:volume", "indicator:sma", "timeframe:daily", "timeframe:weekly", "timeframe:intraday-bars"]
...
This is a **multi-horizon** screen over **nifty 200** with **15** active leaf condition(s) under root join **all (AND)**.
...
- daily count( 5, 1 where ( daily least - daily low ) / ( daily high - daily low ) > 0.5 ) >= 2
- weekly count( 5, 1 where weekly open > 1 day ago close * 1.01 ) >= 1
- [0] 15 minute count( 135, 1 where [0] 15 minute volume > [-1] 15 minute volume * 4 ) >= 2
- ( daily avg true range( 7 ) / daily sma( close ,  7 ) ) * 100 > 3
- daily abs( ( [0] 15 minute close / 1 week ago close ) - 1 ) crossed below 0.005
- daily abs( ( [0] 15 minute close / 2 weeks ago close ) - 1 ) crossed below 0.005
- daily abs( ( [0] 15 minute close / 3 weeks ago close ) - 1 ) crossed below 0.005
- daily abs( ( [0] 15 minute close / 4 weeks ago close ) - 1 ) crossed below 0.005
- daily abs( ( [0] 15 minute close / 5 weeks ago close ) - 1 ) crossed below 0.005
- daily abs( ( [0] 15 minute close / 1 week ago low ) - 1 ) crossed below 0.005
- daily abs( ( [0] 15 minute close / 2 weeks ago low ) - 1 ) crossed below 0.005
- daily abs( ( [0] 15 minute close / 3 weeks ago low ) - 1 ) crossed below 0.005
- daily abs( ( [0] 15 minute close / 4 weeks ago low ) - 1 ) crossed below 0.005
- daily abs( ( [0] 15 minute close / 5 weeks ago low ) - 1 ) crossed below 0.005
- [0] 15 minute sma( close ,  200 ) >= 40000000
...
|---:|---:|---|---|---|---|
| 1 | 1 | Enabled | root | daily count( 5, 1 where ( daily least - daily low ) / ( daily high - daily low ) > 0.5 ) >= 2 | Inequality test: left expression must be strictly greater than right. |
| 2 | 2 | Enabled | root | weekly count( 5, 1 where weekly open > 1 day ago close * 1.01 ) >= 1 | Inequality test: left expression must be strictly greater than right. References weekly bars / weekly offset. |
| 3 | 3 | Disabled | root | daily count( 5, 1 where daily volume > 1 day ago volume * 2 ) >= 1 | Inequality test: left expression must be strictly greater than right. Currently disabled in source — not applied when the scan runs. Volume condition gates participation/liquidity. |
| 4 | 4 | Enabled | root | [0] 15 minute count( 135, 1 where [0] 15 minute volume > [-1] 15 minute volume * 4 ) >= 2 | Inequality test: left expression must be strictly greater than right. Volume condition gates participation/liquidity. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 5 | 5 | Enabled | root | ( daily avg true range( 7 ) / daily sma( close ,  7 ) ) * 100 > 3 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. ATR measures smoothed true range (volatility), not direction. |
| 6 | 7 | Enabled | root/group[cash\|any] | daily abs( ( [0] 15 minute close / 1 week ago close ) - 1 ) crossed below 0.005 | Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data. References weekly bars / weekly offset. |
| 7 | 8 | Enabled | root/group[cash\|any] | daily abs( ( [0] 15 minute close / 2 weeks ago close ) - 1 ) crossed below 0.005 | Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 8 | 9 | Enabled | root/group[cash\|any] | daily abs( ( [0] 15 minute close / 3 weeks ago close ) - 1 ) crossed below 0.005 | Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 9 | 10 | Enabled | root/group[cash\|any] | daily abs( ( [0] 15 minute close / 4 weeks ago close ) - 1 ) crossed below 0.005 | Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 10 | 11 | Enabled | root/group[cash\|any] | daily abs( ( [0] 15 minute close / 5 weeks ago close ) - 1 ) crossed below 0.005 | Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 11 | 12 | Enabled | root/group[cash\|any] | daily abs( ( [0] 15 minute close / 1 week ago low ) - 1 ) crossed below 0.005 | Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data. References weekly bars / weekly offset. |
| 12 | 13 | Enabled | root/group[cash\|any] | daily abs( ( [0] 15 minute close / 2 weeks ago low ) - 1 ) crossed below 0.005 | Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 13 | 14 | Enabled | root/group[cash\|any] | daily abs( ( [0] 15 minute close / 3 weeks ago low ) - 1 ) crossed below 0.005 | Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 14 | 15 | Enabled | root/group[cash\|any] | daily abs( ( [0] 15 minute close / 4 weeks ago low ) - 1 ) crossed below 0.005 | Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 15 | 16 | Enabled | root/group[cash\|any] | daily abs( ( [0] 15 minute close / 5 weeks ago low ) - 1 ) crossed below 0.005 | Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 16 | 17 | Enabled | root | [0] 15 minute sma( close ,  200 ) >= 40000000 | Inequality test: left expression must be greater than or equal to right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
