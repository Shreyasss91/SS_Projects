...
tags: ["bias:upward-condition", "bias:downward-condition", "universe:futures", "indicator:rsi", "indicator:mfi", "indicator:cci", "indicator:volume", "indicator:obv", "timeframe:daily"]
...
- Chartink URL: https://chartink.com/screener/buy-rsi-strong-trend
- Scan ID: `3901831`
- Slug: `buy-rsi-strong-trend`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2021-02-07T08:48:03.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/3901831.json](../source-snapshots/3901831.json)
- Text snapshot: [source-snapshots/3901831.txt](../source-snapshots/3901831.txt)
...
Scan id: 3901831
Slug: buy-rsi-strong-trend
Source URL: https://chartink.com/screener/buy-rsi-strong-trend
...
3. [Enabled] daily mfi( 14 ) crossed below 1 day ago min( 365 ,  daily mfi( 14 ) )
    group_path: root/group[futures|any]
4. [Enabled] daily cci( 20 ) crossed below 1 day ago min( 365 ,  daily cci( 20 ) )
    group_path: root/group[futures|any]
5. [Enabled] daily rsi( 14 ) crossed above 1 day ago min( 365 ,  daily rsi( 14 ) )
    group_path: root/group[futures|any]
6. [Enabled] daily wavetrend( 10 ,  21 ,  4 ) crossed below 1 day ago min( 365 ,  daily wavetrend( 10 ,  21 ,  4 ) )
    group_path: root/group[futures|any]
7. [Enabled] daily RMO crossed below 1 day ago min( 365 ,  daily RMO )
    group_path: root/group[futures|any]
8. [Enabled] daily obv crossed above 1 day ago min( 365 ,  daily obv )
    group_path: root/group[futures|any]
...
- **#3** `daily mfi( 14 ) crossed below 1 day ago min( 365 ,  daily mfi( 14 ) )` — Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). min(N, series) is the lowest value of series over N bars.
- **#4** `daily cci( 20 ) crossed below 1 day ago min( 365 ,  daily cci( 20 ) )` — Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). min(N, series) is the lowest value of series over N bars.
- **#5** `daily rsi( 14 ) crossed above 1 day ago min( 365 ,  daily rsi( 14 ) )` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). RSI is a momentum oscillator from average gains/losses over its period. min(N, series) is the lowest value of series over N bars.
- **#6** `daily wavetrend( 10 ,  21 ,  4 ) crossed below 1 day ago min( 365 ,  daily wavetrend( 10 ,  21 ,  4 ) )` — Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). min(N, series) is the lowest value of series over N bars.
- **#7** `daily RMO crossed below 1 day ago min( 365 ,  daily RMO )` — Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). min(N, series) is the lowest value of series over N bars.
- **#8** `daily obv crossed above 1 day ago min( 365 ,  daily obv )` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). min(N, series) is the lowest value of series over N bars.
...
### Disabled #9
- **Condition (verbatim):** `daily accdist crossed above 1 day ago min( 365 ,  daily accdist )`
...
- `wavetrend` — appears 2 time(s) in the expression tree
- `custom_indicator_4715` — appears 2 time(s) in the expression tree
- `obv` — appears 2 time(s) in the expression tree
