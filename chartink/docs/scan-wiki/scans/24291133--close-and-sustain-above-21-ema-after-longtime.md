...
# close and sustain above 21 ema after longtime

## Source

- Chartink URL: https://chartink.com/screener/close-and-sustain-above-21-ema-after-longtime
- Scan ID: `24291133`
- Slug: `close-and-sustain-above-21-ema-after-longtime`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2025-10-27T18:26:13.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/24291133.json](../source-snapshots/24291133.json)
- Text snapshot: [source-snapshots/24291133.txt](../source-snapshots/24291133.txt)
...
Scan id: 24291133
Slug: close-and-sustain-above-21-ema-after-longtime
Source URL: https://chartink.com/screener/close-and-sustain-above-21-ema-after-longtime
...
3. [Enabled] 3 days ago count streak( 7, 1 where daily close < daily ema( close ,  21 ) ) = 7
    group_path: root/group[cash|all]
4. [Enabled] [GROUP segment=cash join=all combination=passes measurevalue=default]  (path: root/group[cash|all])
5. [Enabled] [0] 30 minute count streak( 2, 1 where [0] 30 minute close > [0] 30 minute ema( close ,  21 ) ) = 2
    group_path: root/group[cash|all]
...
- **#2** `daily count streak( 3, 1 where daily close > daily ema( close ,  21 ) ) = 3` — Inequality test: left expression must be strictly greater than right. EMA is an exponentially weighted moving average of the chosen field.
- **#3** `3 days ago count streak( 7, 1 where daily close < daily ema( close ,  21 ) ) = 7` — Inequality test: left expression must be strictly less than right. EMA is an exponentially weighted moving average of the chosen field.
- **#5** `[0] 30 minute count streak( 2, 1 where [0] 30 minute close > [0] 30 minute ema( close ,  21 ) ) = 2` — Inequality test: left expression must be strictly greater than right. EMA is an exponentially weighted moving average of the chosen field. Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#6** `[-3] 30 minute count streak( 12, 1 where [0] 30 minute close < [0] 30 minute ema( close ,  21 ) ) = 12` — Inequality test: left expression must be strictly less than right. EMA is an exponentially weighted moving average of the chosen field. Uses an intraday bar size (minute timeframe) rather than daily-only data.
...
- Timeframe tokens: `0_days_ago`, `30_minute`, `3_days_ago`
