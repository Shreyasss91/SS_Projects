---
scan_id: 11391251
scan_name: STRONG PRICE REJECTIONS_index_BANKNIFTY
source_url: https://chartink.com/screener/strong-price-rejections-index-banknifty
market: Indian equities
horizon: Swing
classification: ["Price action"]
tags: ["bias:upward-condition", "universe:index", "timeframe:daily"]
captured_at: "2026-07-15T12:56:06+05:30"
enabled_filter_count: 2
disabled_filter_count: 2
needs_review_filter_count: 0
root_segment: BANKNIFTY_INDEX
root_join: any
primary_classification: Price action
---

# STRONG PRICE REJECTIONS_index_BANKNIFTY

## Source

- Chartink URL: https://chartink.com/screener/strong-price-rejections-index-banknifty
- Scan ID: `11391251`
- Slug: `strong-price-rejections-index-banknifty`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-04-01T02:30:43.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/11391251.json](../source-snapshots/11391251.json)
- Text snapshot: [source-snapshots/11391251.txt](../source-snapshots/11391251.txt)

## What this scan is for

This is a **swing** screen over **BANKNIFTY_INDEX** with **2** active leaf condition(s) under root join **any (OR)**.
Its method labels are derived only from active expressions: **Price action**.
The active tests, in captured order, are:
- daily high - daily greatest > 250
- daily high - daily greatest = daily max( 30 ,  daily high - daily greatest )
...
```text
Scan name: STRONG PRICE REJECTIONS_index_BANKNIFTY
Scan id: 11391251
Slug: strong-price-rejections-index-banknifty
Source URL: https://chartink.com/screener/strong-price-rejections-index-banknifty
Root universe/segment: BANKNIFTY_INDEX
Root join: any (OR)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2023-04-01T02:30:43.000000Z

=== Source-faithful rendered tree from atlas_json (includes Enabled and Disabled) ===

1. [Disabled] [GROUP segment=cash join=all combination=passes measurevalue=default]  (path: root/group[cash|all])
2. [Enabled] daily high - daily greatest > 250
...
5. [Enabled] daily high - daily greatest = daily max( 30 ,  daily high - daily greatest )
    group_path: root/group[cash|all]
...
( banknifty_index ( ( cash ( latest high - greatest(  latest open, latest close  ) = latest max( 30 , latest high - greatest(  latest open, latest close  ) ) ) ) ) )
```
...
|---:|---:|---|---|---|---|
| 1 | 2 | Enabled | root/group[cash\|all] | daily high - daily greatest > 250 | Inequality test: left expression must be strictly greater than right. |
...
| 3 | 5 | Enabled | root/group[cash\|all] | daily high - daily greatest = daily max( 30 ,  daily high - daily greatest ) | Equality test between left and right expressions. max(N, series) is the highest value of series over N bars. |
...
- **#2** `daily high - daily greatest > 250` — Inequality test: left expression must be strictly greater than right.
- **#5** `daily high - daily greatest = daily max( 30 ,  daily high - daily greatest )` — Equality test between left and right expressions. max(N, series) is the highest value of series over N bars.
...
- Universe/segment: **BANKNIFTY_INDEX**
- Join: **any**
- Combination: **passes**
...
- **Universe:** results are scoped to **BANKNIFTY_INDEX**. Liquidity and index membership still vary inside that set.
...
- Universe pinned to **BANKNIFTY_INDEX**, which reduces accidental all-market noise relative to an unbounded cash list (when the segment is an index).
