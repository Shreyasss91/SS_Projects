...
- Chartink URL: https://chartink.com/screener/st-bearish-major-reversal
- Scan ID: `2565684`
- Slug: `st-bearish-major-reversal`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2020-07-22T15:32:57.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/2565684.json](../source-snapshots/2565684.json)
- Text snapshot: [source-snapshots/2565684.txt](../source-snapshots/2565684.txt)
...
Scan id: 2565684
Slug: st-bearish-major-reversal
Source URL: https://chartink.com/screener/st-bearish-major-reversal
...
3. [Enabled] daily supertrend( 100 ,  3 ) < daily close
    group_path: root/group[futures|all]
4. [Enabled] [GROUP segment=futures join=all combination=passes measurevalue=default]  (path: root/group[futures|all])
5. [Enabled] 1 day ago supertrend( 50 ,  3 ) > 1 day ago close
    group_path: root/group[futures|all]
...
- **#2** `1 day ago supertrend( 100 ,  3 ) > 1 day ago close` — Inequality test: left expression must be strictly greater than right.
- **#3** `daily supertrend( 100 ,  3 ) < daily close` — Inequality test: left expression must be strictly less than right.
- **#5** `1 day ago supertrend( 50 ,  3 ) > 1 day ago close` — Inequality test: left expression must be strictly greater than right.
- **#6** `daily supertrend( 50 ,  3 ) < daily close` — Inequality test: left expression must be strictly less than right.
...
### Measures observed
- `supertrend` — appears 4 time(s) in the expression tree
...
- **Method context:** Mean reversion, Momentum.
