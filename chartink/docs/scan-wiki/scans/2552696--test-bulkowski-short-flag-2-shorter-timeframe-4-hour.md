...
- Chartink URL: https://chartink.com/screener/test-bulkowski-short-flag-2-shorter-timeframe
- Scan ID: `2552696`
- Slug: `test-bulkowski-short-flag-2-shorter-timeframe`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2020-07-21T02:43:43.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/2552696.json](../source-snapshots/2552696.json)
- Text snapshot: [source-snapshots/2552696.txt](../source-snapshots/2552696.txt)
...
Scan id: 2552696
Slug: test-bulkowski-short-flag-2-shorter-timeframe
Source URL: https://chartink.com/screener/test-bulkowski-short-flag-2-shorter-timeframe
...
3. [Enabled] [GROUP segment=nifty 200 join=all combination=passes measurevalue=default]  (path: root/group[nifty 200|all])
4. [Enabled] [0] 240 minute close > [-5] 240 minute close
    group_path: root/group[nifty 200|all]
5. [Enabled] [-5] 240 minute close > [-27] 240 minute close * 1.22
    group_path: root/group[nifty 200|all]
...
- **#1** `[0] 240 minute volume > [0] 240 minute sma( volume,10 ) * 1.2` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Volume condition gates participation/liquidity. Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#2** `daily volume > 200000` — Inequality test: left expression must be strictly greater than right. Volume condition gates participation/liquidity.
- **#4** `[0] 240 minute close > [-5] 240 minute close` — Inequality test: left expression must be strictly greater than right. Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#5** `[-5] 240 minute close > [-27] 240 minute close * 1.22` — Inequality test: left expression must be strictly greater than right. Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#6** `[0] 240 minute close > [0] 240 minute sma( close,15 )` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data.
