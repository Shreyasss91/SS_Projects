...
# big shadow on one side only

## Source

- Chartink URL: https://chartink.com/screener/big-shadow-on-one-side-only
- Scan ID: `11590232`
- Slug: `big-shadow-on-one-side-only`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-04-27T07:29:47.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/11590232.json](../source-snapshots/11590232.json)
- Text snapshot: [source-snapshots/11590232.txt](../source-snapshots/11590232.txt)
...
Scan id: 11590232
Slug: big-shadow-on-one-side-only
Source URL: https://chartink.com/screener/big-shadow-on-one-side-only
...
- **#2** `daily high - daily greatest > ( daily least - daily low ) * 5` — Inequality test: left expression must be strictly greater than right.
...
### Disabled #3
- **Condition (verbatim):** `daily low - daily least < daily avg true range( 14 ) * -1`
- **Meaning:** Inequality test: left expression must be strictly less than right. Currently disabled in source — not applied when the scan runs. ATR measures smoothed true range (volatility), not direction.
