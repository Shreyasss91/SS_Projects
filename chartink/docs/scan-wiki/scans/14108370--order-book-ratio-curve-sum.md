...
# order book ratio curve sum

## Source

- Chartink URL: https://chartink.com/screener/order-book-ratio-curve-sum
- Scan ID: `14108370`
- Slug: `order-book-ratio-curve-sum`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2023-12-08T02:27:48.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/14108370.json](../source-snapshots/14108370.json)
- Text snapshot: [source-snapshots/14108370.txt](../source-snapshots/14108370.txt)
...
Scan id: 14108370
Slug: order-book-ratio-curve-sum
Source URL: https://chartink.com/screener/order-book-ratio-curve-sum
...
- **#1** `[0] 30 minute sum( close ,  50 ) crossed above 500` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data.
