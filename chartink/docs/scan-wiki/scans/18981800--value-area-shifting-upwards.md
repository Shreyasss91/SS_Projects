...
# Value area shifting upwards

## Source

- Chartink URL: https://chartink.com/screener/value-area-shifting-upwards
- Scan ID: `18981800`
- Slug: `value-area-shifting-upwards`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2024-10-13T12:02:17.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/18981800.json](../source-snapshots/18981800.json)
- Text snapshot: [source-snapshots/18981800.txt](../source-snapshots/18981800.txt)
...
Scan id: 18981800
Slug: value-area-shifting-upwards
Source URL: https://chartink.com/screener/value-area-shifting-upwards
...
- **#2** `[7] 60 minute count( 10, 1 where [7] 60 minute sma( close ,  7 ) > [-7] 60 minute sma( close ,  7 ) ) > 9` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data.
...
### Disabled #1
- **Condition (verbatim):** `[7] 60 minute sma( close ,  7 ) > [-7] 60 minute sma( close ,  7 )`
