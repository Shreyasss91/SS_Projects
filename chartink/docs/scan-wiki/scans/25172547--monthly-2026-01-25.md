---
scan_id: 25172547
scan_name: Monthly 2026-01-25
source_url: https://chartink.com/screener/monthly-2026-01-25-2
market: Indian equities
horizon: Positional
classification: ["Moving average", "Volume/delivery"]
tags: ["bias:upward-condition", "universe:nifty-200", "indicator:volume", "indicator:sma", "timeframe:daily", "timeframe:monthly"]
...
- Chartink URL: https://chartink.com/screener/monthly-2026-01-25-2
- Scan ID: `25172547`
- Slug: `monthly-2026-01-25-2`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Positional
- Created at (Chartink): 2026-01-25T12:44:01.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/25172547.json](../source-snapshots/25172547.json)
- Text snapshot: [source-snapshots/25172547.txt](../source-snapshots/25172547.txt)

## What this scan is for

This is a **positional** screen over **nifty 200** with **2** active leaf condition(s) under root join **all (AND)**.
...
```text
Scan name: Monthly 2026-01-25
Scan id: 25172547
Slug: monthly-2026-01-25-2
Source URL: https://chartink.com/screener/monthly-2026-01-25-2
Root universe/segment: nifty 200
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2026-01-25T12:44:01.000000Z

=== Source-faithful rendered tree from atlas_json (includes Enabled and Disabled) ===

1. [Disabled] monthly open = monthly low
2. [Enabled] 1 day ago volume > 1 day ago sma( close ,  20 ) * 2
3. [Enabled] daily open > 1 day ago close * 1.010

=== Literal Chartink atlas_query (compiled active query; typically omits disabled filters) ===

( nifty 200 (  1 day ago volume >  1 day ago sma(  daily volume , 20 ) *  2 and  daily open >  1 day ago close *  1.010 ) )
```
...
|---:|---:|---|---|---|---|
| 1 | 1 | Disabled | root | monthly open = monthly low | Equality test between left and right expressions. Currently disabled in source — not applied when the scan runs. References monthly bars / monthly offset. |
| 2 | 2 | Enabled | root | 1 day ago volume > 1 day ago sma( close ,  20 ) * 2 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Volume condition gates participation/liquidity. |
| 3 | 3 | Enabled | root | daily open > 1 day ago close * 1.010 | Inequality test: left expression must be strictly greater than right. |
...
### Disabled #1
- **Condition (verbatim):** `monthly open = monthly low`
- **Meaning:** Equality test between left and right expressions. Currently disabled in source — not applied when the scan runs. References monthly bars / monthly offset.
