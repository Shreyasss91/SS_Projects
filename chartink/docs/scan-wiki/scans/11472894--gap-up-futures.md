---
scan_id: 11472894
scan_name: gap up futures
source_url: https://chartink.com/screener/gap-up-futures-21
...
- Chartink URL: https://chartink.com/screener/gap-up-futures-21
- Scan ID: `11472894`
- Slug: `gap-up-futures-21`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-04-12T10:37:29.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/11472894.json](../source-snapshots/11472894.json)
- Text snapshot: [source-snapshots/11472894.txt](../source-snapshots/11472894.txt)

## What this scan is for

This scan, titled "gap up futures", appears designed to screen Indian equities in the **futures** universe using **1 enabled** condition(s) combined with root join **all (AND)**.
...
```text
Scan name: gap up futures
Scan id: 11472894
Slug: gap-up-futures-21
Source URL: https://chartink.com/screener/gap-up-futures-21
Root universe/segment: futures
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2023-04-12T10:37:29.000000Z

=== Condition tree (from atlas_json; includes Enabled and Disabled) ===

1. [Enabled] daily open > 1 day ago close * 1.01

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( futures ( latest open > 1 day ago close * 1.01 ) )
```
...
|---:|---|---|---|
| 1 | Enabled | daily open > 1 day ago close * 1.01 | Inequality test: left expression must be strictly greater than right. |
...
- **#1** `daily open > 1 day ago close * 1.01` — Inequality test: left expression must be strictly greater than right.
