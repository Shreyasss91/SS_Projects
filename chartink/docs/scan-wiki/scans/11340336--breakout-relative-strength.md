...
tags: ["bias:upward-condition", "universe:cash", "indicator:volume", "indicator:ema", "indicator:sma", "timeframe:daily"]
...
- Chartink URL: https://chartink.com/screener/breakout-relative-strength
- Scan ID: `11340336`
- Slug: `breakout-relative-strength`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-03-24T04:43:31.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/11340336.json](../source-snapshots/11340336.json)
- Text snapshot: [source-snapshots/11340336.txt](../source-snapshots/11340336.txt)

## What this scan is for

This is a **swing** screen over **cash** with **10** active leaf condition(s) under root join **all (AND)**.
...
Scan id: 11340336
Slug: breakout-relative-strength
Source URL: https://chartink.com/screener/breakout-relative-strength
...
3. [Enabled] daily close = daily max( 250 ,  daily close )
    group_path: root/group[cash|all]
4. [Enabled] daily volume > daily sma( close ,  50 ) * 2
    group_path: root/group[cash|all]
5. [Enabled] daily close > daily high / 1.25
    group_path: root/group[cash|all]
6. [Enabled] ( daily close - daily ema( close,200 ) ) / daily ema( close,200 ) * 100 > 30
    group_path: root/group[cash|all]
7. [Enabled] ( daily close - 125 days ago close ) / 125 days ago close * 100 > 20
    group_path: root/group[cash|all]
8. [Enabled] ( daily close - daily ema( close,50 ) ) / daily ema( close,50 ) * 100 > 20
    group_path: root/group[cash|all]
9. [Enabled] ( daily close - 20 days ago close ) / 20 days ago close * 100 > 20
    group_path: root/group[cash|all]
10. [Enabled] daily close > 50
    group_path: root/group[cash|all]
...
- **#3** `daily close = daily max( 250 ,  daily close )` — Equality test between left and right expressions. max(N, series) is the highest value of series over N bars.
- **#4** `daily volume > daily sma( close ,  50 ) * 2` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Volume condition gates participation/liquidity.
- **#5** `daily close > daily high / 1.25` — Inequality test: left expression must be strictly greater than right.
- **#6** `( daily close - daily ema( close,200 ) ) / daily ema( close,200 ) * 100 > 30` — Inequality test: left expression must be strictly greater than right. EMA is an exponentially weighted moving average of the chosen field.
- **#7** `( daily close - 125 days ago close ) / 125 days ago close * 100 > 20` — Inequality test: left expression must be strictly greater than right.
- **#8** `( daily close - daily ema( close,50 ) ) / daily ema( close,50 ) * 100 > 20` — Inequality test: left expression must be strictly greater than right. EMA is an exponentially weighted moving average of the chosen field.
- **#9** `( daily close - 20 days ago close ) / 20 days ago close * 100 > 20` — Inequality test: left expression must be strictly greater than right.
- **#10** `daily close > 50` — Inequality test: left expression must be strictly greater than right.
- **#11** `daily volume > 100000` — Inequality test: left expression must be strictly greater than right. Volume condition gates participation/liquidity.
...
- Timeframe tokens: `0_days_ago`, `125_days_ago`, `1_days_ago`, `20_days_ago`
