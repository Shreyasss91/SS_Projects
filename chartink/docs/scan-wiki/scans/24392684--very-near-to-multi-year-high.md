...
horizon: Swing
classification: ["Fundamental", "Moving average", "Breakout", "Trend following", "Momentum", "Multi-factor"]
tags: ["bias:upward-condition", "bias:downward-condition", "universe:cash", "indicator:ema", "timeframe:daily", "timeframe:weekly"]
...
Its method labels are derived only from active expressions: **Fundamental, Moving average, Breakout, Trend following, Momentum, Multi-factor**.
...
- **Method context:** Fundamental, Moving average, Breakout, Trend following, Momentum, Multi-factor.
...
- **Horizon:** Swing
- **Methods:** Fundamental, Moving average, Breakout, Trend following, Momentum, Multi-factor
- **Tags:** bias:upward-condition, bias:downward-condition, universe:cash, indicator:ema, timeframe:daily, timeframe:weekly
- **Root universe:** cash
- **Root join:** all
