...
tags: ["universe:nifty-200","indicator:sma","indicator:ema","timeframe:intraday-bars","timeframe:daily","timeframe:weekly"]
...
This is a **multi-horizon** screen over **nifty 200** with **18** active leaf condition(s) under root join **all**.
Its method labels are derived only from active expressions: **Moving average, Breakout**.

The active tests, in captured order:
- [75] 5 minute sma( close ,  20 ) > [69] 5 minute sma( close ,  20 ) * 1.8
- [74] 5 minute sma( close ,  20 ) > [68] 5 minute sma( close ,  20 ) * 1.8
- [73] 5 minute sma( close ,  20 ) > [67] 5 minute sma( close ,  20 ) * 1.8
- [72] 5 minute sma( close ,  20 ) > [66] 5 minute sma( close ,  20 ) * 1.8
- [71] 5 minute sma( close ,  20 ) > [65] 5 minute sma( close ,  20 ) * 1.8
- [70] 5 minute sma( close ,  20 ) > [64] 5 minute sma( close ,  20 ) * 1.8
- [69] 5 minute sma( close ,  20 ) > [63] 5 minute sma( close ,  20 ) * 1.8
- [68] 5 minute sma( close ,  20 ) > [62] 5 minute sma( close ,  20 ) * 1.8
- [67] 5 minute sma( close ,  20 ) > [61] 5 minute sma( close ,  20 ) * 1.8
- [66] 5 minute sma( close ,  20 ) > [60] 5 minute sma( close ,  20 ) * 1.8
...
|---:|---:|---|---|---|---|
| 1 | 2 | Enabled | root/group[cash\|any] | [75] 5 minute sma( close ,  20 ) > [69] 5 minute sma( close ,  20 ) * 1.8 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 2 | 3 | Enabled | root/group[cash\|any] | [74] 5 minute sma( close ,  20 ) > [68] 5 minute sma( close ,  20 ) * 1.8 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 3 | 4 | Enabled | root/group[cash\|any] | [73] 5 minute sma( close ,  20 ) > [67] 5 minute sma( close ,  20 ) * 1.8 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 4 | 5 | Enabled | root/group[cash\|any] | [72] 5 minute sma( close ,  20 ) > [66] 5 minute sma( close ,  20 ) * 1.8 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 5 | 6 | Enabled | root/group[cash\|any] | [71] 5 minute sma( close ,  20 ) > [65] 5 minute sma( close ,  20 ) * 1.8 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 6 | 7 | Enabled | root/group[cash\|any] | [70] 5 minute sma( close ,  20 ) > [64] 5 minute sma( close ,  20 ) * 1.8 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 7 | 8 | Enabled | root/group[cash\|any] | [69] 5 minute sma( close ,  20 ) > [63] 5 minute sma( close ,  20 ) * 1.8 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 8 | 9 | Enabled | root/group[cash\|any] | [68] 5 minute sma( close ,  20 ) > [62] 5 minute sma( close ,  20 ) * 1.8 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 9 | 10 | Enabled | root/group[cash\|any] | [67] 5 minute sma( close ,  20 ) > [61] 5 minute sma( close ,  20 ) * 1.8 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 10 | 11 | Enabled | root/group[cash\|any] | [66] 5 minute sma( close ,  20 ) > [60] 5 minute sma( close ,  20 ) * 1.8 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 11 | 12 | Disabled | root | [75] 5 minute sma( close ,  20 ) > 1 | Inequality test: left expression must be strictly greater than right. Currently disabled in source — not applied when the scan runs. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 12 | 14 | Enabled | root/group[cash\|all] | daily close > daily ema( close ,  50 ) | Inequality test: left expression must be strictly greater than right. EMA is an exponentially weighted moving average of the chosen field. |
| 13 | 15 | Enabled | root/group[cash\|all] | daily close > daily sma( close ,  200 ) | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. |
| 14 | 16 | Enabled | root/group[cash\|all] | weekly close > weekly ema( close ,  50 ) | Inequality test: left expression must be strictly greater than right. EMA is an exponentially weighted moving average of the chosen field. References weekly bars / weekly offset. |
| 15 | 17 | Enabled | root/group[cash\|all] | daily close >= weekly max( 52 ,  weekly high ) * 0.50 | Inequality test: left expression must be greater than or equal to right. max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset. |
| 16 | 18 | Enabled | root/group[cash\|all] | daily % change <= 3 | Inequality test: left expression must be less than or equal to right. |
| 17 | 19 | Enabled | root/group[cash\|all] | daily % change > -2 | Inequality test: left expression must be strictly greater than right. |
| 18 | 20 | Disabled | root/group[cash\|all] | daily close >= 30 | Inequality test: left expression must be greater than or equal to right. Currently disabled in source — not applied when the scan runs. |
| 19 | 21 | Disabled | root/group[cash\|all] | daily close <= 1000 | Inequality test: left expression must be less than or equal to right. Currently disabled in source — not applied when the scan runs. |
| 20 | 22 | Disabled | root/group[cash\|all] | daily market cap <= 20000 | Inequality test: left expression must be less than or equal to right. Currently disabled in source — not applied when the scan runs. Filters by market-capitalisation field from Chartink fundamentals. |
| 21 | 23 | Disabled | root/group[cash\|all] | daily volume >= 100000 | Inequality test: left expression must be greater than or equal to right. Currently disabled in source — not applied when the scan runs. Volume condition gates participation/liquidity. |
| 22 | 24 | Enabled | root/group[cash\|all] | 0 quarters ago net sales > 1 quarters ago gross sales | Inequality test: left expression must be strictly greater than right. |
| 23 | 25 | Enabled | root/group[cash\|all] | 0 quarters ago gross profit/pbdt > 1 quarters ago gross profit/pbdt | Inequality test: left expression must be strictly greater than right. |
