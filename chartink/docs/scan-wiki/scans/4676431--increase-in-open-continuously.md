...
# increase in open continuously

## Source

- Chartink URL: https://chartink.com/screener/increase-in-open-continuously
- Scan ID: `4676431`
- Slug: `increase-in-open-continuously`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2021-05-25T15:29:25.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/4676431.json](../source-snapshots/4676431.json)
- Text snapshot: [source-snapshots/4676431.txt](../source-snapshots/4676431.txt)

## What this scan is for

This scan, titled "increase in open continuously", appears designed to screen Indian equities in the **cash** universe using **3 enabled** condition(s) combined with root join **all (AND)**.
...
```text
Scan name: increase in open continuously
Scan id: 4676431
Slug: increase-in-open-continuously
Source URL: https://chartink.com/screener/increase-in-open-continuously
Root universe/segment: cash
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2021-05-25T15:29:25.000000Z
...
3. [Enabled] daily count( 6, 1 where daily open > 1 day ago open ) > 5

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( cash ( 1 day ago close * 1 day ago volume > 100000000 and latest count( 200, 1 where( latest high / latest low ) = 1 ) < 1 and latest count( 6, 1 where latest open > 1 day ago open ) > 5 ) )
```
...
| 3 | Enabled | daily count( 6, 1 where daily open > 1 day ago open ) > 5 | Inequality test: left expression must be strictly greater than right. |
...
- **#3** `daily count( 6, 1 where daily open > 1 day ago open ) > 5` — Inequality test: left expression must be strictly greater than right.
