...
tags: ["universe:nifty-500","timeframe:daily","timeframe:weekly"]
...
This is a **swing** screen over **nifty 500** with **4** active leaf condition(s) under root join **any**.
Its method labels are derived only from active expressions: **Volume/delivery, Breakout, Momentum**.

The active tests, in captured order:
- 1 day ago accdist - ( 1 day ago max( 21 ,  daily accdist ) - 1 day ago min( 21 ,  daily accdist ) ) crossed below daily accdist
- daily low < 1 day ago min( 21 ,  daily low )
...
|---:|---:|---|---|---|---|
| 1 | 2 | Enabled | root/group[cash\|all] | 1 day ago accdist - ( 1 day ago max( 21 ,  daily accdist ) - 1 day ago min( 21 ,  daily accdist ) ) crossed below daily accdist | Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars. |
| 2 | 3 | Enabled | root/group[cash\|all] | daily low < 1 day ago min( 21 ,  daily low ) | Inequality test: left expression must be strictly less than right. min(N, series) is the lowest value of series over N bars. |
