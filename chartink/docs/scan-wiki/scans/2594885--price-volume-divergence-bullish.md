...
- Chartink URL: https://chartink.com/screener/price-volume-divergence-bullish
- Scan ID: `2594885`
- Slug: `price-volume-divergence-bullish`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2020-07-26T10:54:48.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/2594885.json](../source-snapshots/2594885.json)
- Text snapshot: [source-snapshots/2594885.txt](../source-snapshots/2594885.txt)
...
Scan id: 2594885
Slug: price-volume-divergence-bullish
Source URL: https://chartink.com/screener/price-volume-divergence-bullish
...
- **#1** `daily count streak( 6, 1 where daily close < 1 day ago close * 1 ) >= 6` — Inequality test: left expression must be strictly less than right.
- **#2** `daily sma( close ,  5 ) > 5 days ago sma( close ,  5 ) * 1.3` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars.
- **#3** `daily sma( close ,  5 ) > daily sma( close ,  20 )` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars.
