...
- Chartink URL: https://chartink.com/screener/21d-consolidation-bo-4
- Scan ID: `11341240`
- Slug: `21d-consolidation-bo-4`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-03-24T07:01:04.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/11341240.json](../source-snapshots/11341240.json)
- Text snapshot: [source-snapshots/11341240.txt](../source-snapshots/11341240.txt)
...
Scan id: 11341240
Slug: 21d-consolidation-bo-4
Source URL: https://chartink.com/screener/21d-consolidation-bo-4
...
3. [Enabled] daily close crossed above 1 day ago max( 21 ,  daily close )
    group_path: root/group[cash|all]
4. [Enabled] 1 day ago min( 21 ,  daily close ) >= 1 day ago max( 21 ,  daily close ) * 0.7
    group_path: root/group[cash|all]
5. [Enabled] daily volume > daily sma( close ,  21 ) * 1.5
    group_path: root/group[cash|all]
...
- **#3** `daily close crossed above 1 day ago max( 21 ,  daily close )` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars.
- **#4** `1 day ago min( 21 ,  daily close ) >= 1 day ago max( 21 ,  daily close ) * 0.7` — Inequality test: left expression must be greater than or equal to right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars.
- **#5** `daily volume > daily sma( close ,  21 ) * 1.5` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Volume condition gates participation/liquidity.
- **#6** `daily close >= 10` — Inequality test: left expression must be greater than or equal to right.
