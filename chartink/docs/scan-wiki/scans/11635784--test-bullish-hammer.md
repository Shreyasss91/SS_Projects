...
- daily close > 50
- daily abs( daily high - daily close ) / ( daily high - daily low ) < 0.15
- daily abs( daily open - daily close ) / ( daily high - daily low ) < 0.5
...
| 4 | 5 | Enabled | root | daily abs( daily high - daily close ) / ( daily high - daily low ) < 0.15 | Inequality test: left expression must be strictly less than right. |
| 5 | 6 | Enabled | root | daily abs( daily open - daily close ) / ( daily high - daily low ) < 0.5 | Inequality test: left expression must be strictly less than right. |
