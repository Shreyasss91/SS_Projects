...
tags: ["bias:upward-condition", "universe:futures", "indicator:volume", "timeframe:daily"]
...
| 2 | 3 | Enabled | root/group[futures\|any] | daily ln_x crossed above 1 day ago min( 365 ,  daily ln_x ) | Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). min(N, series) is the lowest value of series over N bars. |
