---
scan_id: 13792059
scan_name: Bull 2023-11-12
source_url: https://chartink.com/screener/bull-2023-11-12
...
- Chartink URL: https://chartink.com/screener/bull-2023-11-12
- Scan ID: `13792059`
- Slug: `bull-2023-11-12`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-11-12T04:29:44.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/13792059.json](../source-snapshots/13792059.json)
- Text snapshot: [source-snapshots/13792059.txt](../source-snapshots/13792059.txt)

## What this scan is for

This scan, titled "Bull 2023-11-12", appears designed to screen Indian equities in the **futures** universe using **2 enabled** condition(s) combined with root join **all (AND)**.
...
```text
Scan name: Bull 2023-11-12
Scan id: 13792059
Slug: bull-2023-11-12
Source URL: https://chartink.com/screener/bull-2023-11-12
Root universe/segment: futures
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2023-11-12T04:29:44.000000Z

=== Condition tree (from atlas_json; includes Enabled and Disabled) ===

1. [Enabled] daily open < 1 day ago close * 0.99
2. [Enabled] daily close > 1 day ago close * 1.01

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( futures ( latest open < 1 day ago close * 0.99 and latest close > 1 day ago close * 1.01 ) )
```
...
|---:|---|---|---|
| 1 | Enabled | daily open < 1 day ago close * 0.99 | Inequality test: left expression must be strictly less than right. |
...
- **#1** `daily open < 1 day ago close * 0.99` — Inequality test: left expression must be strictly less than right.
