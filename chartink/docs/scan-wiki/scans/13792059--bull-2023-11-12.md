...
|---:|---:|---|---|---|---|
| 1 | 1 | Enabled | root | daily open < 1 day ago close * 0.99 | Inequality test: left expression must be strictly less than right. |
| 2 | 2 | Enabled | root | daily close > 1 day ago close * 1.01 | Inequality test: left expression must be strictly greater than right. |
