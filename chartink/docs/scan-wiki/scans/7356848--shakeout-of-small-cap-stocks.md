---
scan_id: 7356848
scan_name: Shakeout of small cap stocks
source_url: https://chartink.com/screener/shakeout-of-small-cap-stocks
...
# Shakeout of small cap stocks

## Source

- Chartink URL: https://chartink.com/screener/shakeout-of-small-cap-stocks
- Scan ID: `7356848`
- Slug: `shakeout-of-small-cap-stocks`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2022-01-02T16:53:26.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/7356848.json](../source-snapshots/7356848.json)
- Text snapshot: [source-snapshots/7356848.txt](../source-snapshots/7356848.txt)

## What this scan is for

This scan, titled "Shakeout of small cap stocks", appears designed to screen Indian equities in the **cash** universe using **6 enabled** condition(s) combined with root join **any (OR)**.

Dominant method tag(s) inferred from conditions: **Moving average, Fundamental**. Likely horizon label from name/timeframes: **Swing**.
...
```text
Scan name: Shakeout of small cap stocks
Scan id: 7356848
Slug: shakeout-of-small-cap-stocks
Source URL: https://chartink.com/screener/shakeout-of-small-cap-stocks
Root universe/segment: cash
Root join: any (OR)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2022-01-02T16:53:26.000000Z
...
( cash ( ( cash ( latest low < least(  latest open, latest close  ) * 0.95 and market cap > 1000 and market cap < 10000 ) ) or( cash ( latest high > greatest(  latest open, latest close  ) * 1.05 and market cap > 1000 and market cap < 10000 ) ) ) )
```
...
- **Method context:** Moving average, Fundamental.
