...
- Chartink URL: https://chartink.com/screener/simple-volume-with-pocket-pivots-intraday
- Scan ID: `8376486`
- Slug: `simple-volume-with-pocket-pivots-intraday`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2022-04-20T06:31:45.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/8376486.json](../source-snapshots/8376486.json)
- Text snapshot: [source-snapshots/8376486.txt](../source-snapshots/8376486.txt)
...
Scan id: 8376486
Slug: simple-volume-with-pocket-pivots-intraday
Source URL: https://chartink.com/screener/simple-volume-with-pocket-pivots-intraday
...
6. [Enabled] daily % change < 1
    group_path: root/group[cash|all]
7. [Enabled] [0] 240 minute close > [-1] 240 minute close
...
- **#7** `[0] 240 minute close > [-1] 240 minute close` — Inequality test: left expression must be strictly greater than right. Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#8** `[0] 240 minute count( 21, 1 where [0] 240 minute close < [-1] 240 minute close ) >= 10` — Inequality test: left expression must be strictly less than right. Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#9** `[0] 240 minute volume > [0] 240 minute min( 21 ,  ( [0] 240 minute close - [-1] 240 minute close ) / [0] 240 minute abs( [0] 240 minute close - [-1] 240 minute close ) * [0] 240 minute volume ) * -0.9` — Inequality test: left expression must be strictly greater than right. Volume condition gates participation/liquidity. min(N, series) is the lowest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data.
...
- **Method context:** Support/resistance, Volume/delivery, Fundamental, Multi-factor.
