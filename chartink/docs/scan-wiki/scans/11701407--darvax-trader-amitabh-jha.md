...
horizon: Swing
classification: ["Fundamental", "Moving average", "Support/resistance", "Volume/delivery", "Trend following", "Momentum", "Multi-factor"]
tags: ["bias:upward-condition", "universe:futures", "indicator:volume", "indicator:pivot", "indicator:ema", "indicator:sma", "timeframe:daily", "timeframe:weekly"]
...
Its method labels are derived only from active expressions: **Fundamental, Moving average, Support/resistance, Volume/delivery, Trend following, Momentum, Multi-factor**.
...
- **Method context:** Fundamental, Moving average, Support/resistance, Volume/delivery, Trend following, Momentum, Multi-factor.
...
- **Horizon:** Swing
- **Methods:** Fundamental, Moving average, Support/resistance, Volume/delivery, Trend following, Momentum, Multi-factor
- **Tags:** bias:upward-condition, universe:futures, indicator:volume, indicator:pivot, indicator:ema, indicator:sma, timeframe:daily, timeframe:weekly
