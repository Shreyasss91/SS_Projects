...
- Chartink URL: https://chartink.com/screener/subasish-pani-2
- Scan ID: `11638308`
- Slug: `subasish-pani-2`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-05-02T19:34:57.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/11638308.json](../source-snapshots/11638308.json)
- Text snapshot: [source-snapshots/11638308.txt](../source-snapshots/11638308.txt)
...
Scan id: 11638308
Slug: subasish-pani-2
Source URL: https://chartink.com/screener/subasish-pani-2
...
4. [Enabled] daily close > 50
    group_path: root/group[cash|all]
5. [Enabled] 1 day ago count( 3, 1 where daily close > daily open ) >= 2
...
- **#5** `1 day ago count( 3, 1 where daily close > daily open ) >= 2` — Inequality test: left expression must be strictly greater than right.
- **#6** `daily open < 1 day ago low` — Inequality test: left expression must be strictly less than right.
...
### Disabled #7
- **Condition (verbatim):** `daily open < 1 day ago close - ( ( 1 day ago close - 1 day ago open ) / 2 )`
