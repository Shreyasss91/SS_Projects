...
tags: ["bias:upward-condition", "bias:downward-condition", "universe:nifty-200", "timeframe:daily", "timeframe:monthly", "timeframe:weekly"]
...
- Chartink URL: https://chartink.com/screener/gap-down-below-monthly-low
- Scan ID: `19081847`
...
- Raw snapshot: [source-snapshots/19081847.json](../source-snapshots/19081847.json)
- Text snapshot: [source-snapshots/19081847.txt](../source-snapshots/19081847.txt)
...
Scan id: 19081847
Slug: gap-down-below-monthly-low
Source URL: https://chartink.com/screener/gap-down-below-monthly-low
...
- **#2** `1 day ago close > 1 month ago low * 1` — Inequality test: left expression must be strictly greater than right. References monthly bars / monthly offset.
- **#3** `daily open < 1 month ago low * 1` — Inequality test: left expression must be strictly less than right. References monthly bars / monthly offset.
- **#5** `1 day ago close < 1 month ago high * 1` — Inequality test: left expression must be strictly less than right. References monthly bars / monthly offset.
- **#6** `daily open > 1 month ago high * 1` — Inequality test: left expression must be strictly greater than right. References monthly bars / monthly offset.
- **#8** `1 day ago close < 1 week ago high * 1` — Inequality test: left expression must be strictly less than right. References weekly bars / weekly offset.
- **#9** `daily open > 1 week ago high * 1` — Inequality test: left expression must be strictly greater than right. References weekly bars / weekly offset.
...
- Timeframe tokens: `0_days_ago`, `0_months_ago`, `1_days_ago`, `1_months_ago`, `1_weeks_ago`
