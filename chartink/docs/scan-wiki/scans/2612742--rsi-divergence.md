...
tags: ["universe:cash", "indicator:rsi", "indicator:volume", "timeframe:daily"]
...
This scan, titled "rsi divergence", appears designed to screen Indian equities in the **cash** universe using **25 enabled** condition(s) combined with root join **any (OR)**.
...
Observed Chartink timeframe offsets in the tree: `0_days_ago, 14_days_ago, 1_days_ago, 6_days_ago, 7_days_ago, 8_days_ago, 9_days_ago`.
...
| 2 | Enabled | 1 day ago close * 1 day ago volume > 1000000000 | Inequality test: left expression must be strictly greater than right. Volume condition gates participation/liquidity. |
| 3 | Enabled | daily high < 6 days ago high * 1.001 | Inequality test: left expression must be strictly less than right. |
| 4 | Enabled | daily high > 6 days ago high * 0.999 | Inequality test: left expression must be strictly greater than right. |
| 5 | Enabled | 1 day ago max( 4 ,  daily high ) < 6 days ago high | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. |
| 6 | Enabled | daily rsi( 14 ) < 6 days ago rsi( 14 ) * 0.9 | Inequality test: left expression must be strictly less than right. RSI is a momentum oscillator from average gains/losses over its period. |
...
| 8 | Enabled | 1 day ago close * 1 day ago volume > 1000000000 | Inequality test: left expression must be strictly greater than right. Volume condition gates participation/liquidity. |
| 9 | Enabled | daily high < 7 days ago high * 1.001 | Inequality test: left expression must be strictly less than right. |
| 10 | Enabled | daily high > 7 days ago high * 0.999 | Inequality test: left expression must be strictly greater than right. |
| 11 | Enabled | 1 day ago max( 5 ,  daily high ) < 7 days ago high | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. |
| 12 | Enabled | daily rsi( 14 ) < 7 days ago rsi( 14 ) * 0.9 | Inequality test: left expression must be strictly less than right. RSI is a momentum oscillator from average gains/losses over its period. |
...
| 14 | Enabled | 1 day ago close * 1 day ago volume > 1000000000 | Inequality test: left expression must be strictly greater than right. Volume condition gates participation/liquidity. |
| 15 | Enabled | daily high < 8 days ago high * 1.001 | Inequality test: left expression must be strictly less than right. |
| 16 | Enabled | daily high > 8 days ago high * 0.999 | Inequality test: left expression must be strictly greater than right. |
| 17 | Enabled | 1 day ago max( 6 ,  daily high ) < 8 days ago high | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. |
| 18 | Enabled | daily rsi( 14 ) < 8 days ago rsi( 14 ) * 0.9 | Inequality test: left expression must be strictly less than right. RSI is a momentum oscillator from average gains/losses over its period. |
...
| 20 | Enabled | 1 day ago close * 1 day ago volume > 1000000000 | Inequality test: left expression must be strictly greater than right. Volume condition gates participation/liquidity. |
| 21 | Enabled | daily high < 9 days ago high * 1.001 | Inequality test: left expression must be strictly less than right. |
| 22 | Enabled | daily high > 9 days ago high * 0.999 | Inequality test: left expression must be strictly greater than right. |
| 23 | Enabled | 1 day ago max( 7 ,  daily high ) < 9 days ago high | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. |
| 24 | Enabled | daily rsi( 14 ) < 9 days ago rsi( 14 ) * 0.9 | Inequality test: left expression must be strictly less than right. RSI is a momentum oscillator from average gains/losses over its period. |
...
| 26 | Enabled | 1 day ago close * 1 day ago volume > 1000000000 | Inequality test: left expression must be strictly greater than right. Volume condition gates participation/liquidity. |
| 27 | Enabled | daily high < 14 days ago high * 1.001 | Inequality test: left expression must be strictly less than right. |
| 28 | Enabled | daily high > 14 days ago high * 0.999 | Inequality test: left expression must be strictly greater than right. |
| 29 | Enabled | 1 day ago max( 12 ,  daily high ) < 14 days ago high | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. |
| 30 | Enabled | daily rsi( 14 ) < 14 days ago rsi( 14 ) * 0.9 | Inequality test: left expression must be strictly less than right. RSI is a momentum oscillator from average gains/losses over its period. |
