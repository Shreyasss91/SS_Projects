...
tags: ["bias:upward-condition", "bias:downward-condition", "universe:futures", "indicator:pivot", "timeframe:daily", "timeframe:monthly", "timeframe:intraday-bars"]
...
- Chartink URL: https://chartink.com/screener/test-pivot-38
- Scan ID: `6299032`
- Slug: `test-pivot-38`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Multi-horizon
- Created at (Chartink): 2021-09-26T04:58:07.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/6299032.json](../source-snapshots/6299032.json)
- Text snapshot: [source-snapshots/6299032.txt](../source-snapshots/6299032.txt)

## What this scan is for

This is a **multi-horizon** screen over **futures** with **2** active leaf condition(s) under root join **all (AND)**.
...
Scan id: 6299032
Slug: test-pivot-38
Source URL: https://chartink.com/screener/test-pivot-38
...
- **#1** `[0] 60 minute close crossed below 1 month ago pivot point s1 * 1.01` — Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Pivot fields are classic floor-trader support/resistance levels from prior period H/L/C. Uses an intraday bar size (minute timeframe) rather than daily-only data. References monthly bars / monthly offset.
- **#2** `[0] 60 minute close > 1 month ago pivot point s1 * 1.00` — Inequality test: left expression must be strictly greater than right. Pivot fields are classic floor-trader support/resistance levels from prior period H/L/C. Uses an intraday bar size (minute timeframe) rather than daily-only data. References monthly bars / monthly offset.
...
- `pivot point s1` — appears 2 time(s) in the expression tree
...
- Timeframe tokens: `0_days_ago`, `1_months_ago`, `60_minute`
