---
scan_id: 13876865
scan_name: volume  spike in morning 30 mins
source_url: https://chartink.com/screener/volume-spike-in-morning-30-mins
...
# volume  spike in morning 30 mins

## Source

- Chartink URL: https://chartink.com/screener/volume-spike-in-morning-30-mins
- Scan ID: `13876865`
- Slug: `volume-spike-in-morning-30-mins`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2023-11-20T02:13:39.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/13876865.json](../source-snapshots/13876865.json)
- Text snapshot: [source-snapshots/13876865.txt](../source-snapshots/13876865.txt)

## What this scan is for

This scan, titled "volume  spike in morning 30 mins", appears designed to screen Indian equities in the **cash** universe using **3 enabled** condition(s) combined with root join **all (AND)**.
...
```text
Scan name: volume  spike in morning 30 mins
Scan id: 13876865
Slug: volume-spike-in-morning-30-mins
Source URL: https://chartink.com/screener/volume-spike-in-morning-30-mins
Root universe/segment: cash
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2023-11-20T02:13:39.000000Z
...
4. [Enabled] daily close > 50
    group_path: root/group[cash|all]
5. [Enabled] [1] 30 minute volume / [-1] 30 minute sma( close ,  7 ) > 20

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( cash ( ( cash ( 1 day ago close * 1 day ago volume > 100000000 and latest close > 50 ) ) and [=1] 30 minute volume / [=-1] 30 minute sma( [=1] 30 minute volume , 7 ) > 20 ) )
```
...
| 5 | Enabled | [1] 30 minute volume / [-1] 30 minute sma( close ,  7 ) > 20 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Volume condition gates participation/liquidity. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
...
- **#5** `[1] 30 minute volume / [-1] 30 minute sma( close ,  7 ) > 20` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Volume condition gates participation/liquidity. Uses an intraday bar size (minute timeframe) rather than daily-only data.
