...
- Chartink URL: https://chartink.com/screener/adx-breaking-channel
- Scan ID: `4842804`
- Slug: `adx-breaking-channel`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2021-06-07T02:24:58.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/4842804.json](../source-snapshots/4842804.json)
- Text snapshot: [source-snapshots/4842804.txt](../source-snapshots/4842804.txt)

## What this scan is for

This is a **intraday** screen over **cash** with **2** active leaf condition(s) under root join **any (OR)**.
...
Scan id: 4842804
Slug: adx-breaking-channel
Source URL: https://chartink.com/screener/adx-breaking-channel
...
3. [Enabled] 1 day ago close * 1 day ago volume > 100000000
    group_path: root/group[nifty 200|all]
4. [Disabled] 1 day ago close * 1 day ago volume < 10000000000
    group_path: root/group[nifty 200|all]
...
- **#5** `( [0] 15 minute adx di positive( 250 ) - [0] 15 minute max( 120 ,  [-48] 15 minute adx di positive( 250 ) ) ) / daily abs( [0] 15 minute max( 120 ,  [-48] 15 minute adx di positive( 250 ) ) ) crossed above 0.04` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data.
