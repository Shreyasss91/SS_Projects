---
scan_id: 4735194
scan_name: "price consolidation within 1%"
source_url: https://chartink.com/screener/price-consolidation-within-1
...
# price consolidation within 1%

## Source

- Chartink URL: https://chartink.com/screener/price-consolidation-within-1
- Scan ID: `4735194`
- Slug: `price-consolidation-within-1`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2021-05-30T12:05:03.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/4735194.json](../source-snapshots/4735194.json)
- Text snapshot: [source-snapshots/4735194.txt](../source-snapshots/4735194.txt)

## What this scan is for

This scan, titled "price consolidation within 1%", appears designed to screen Indian equities in the **cash** universe using **3 enabled** condition(s) combined with root join **all (AND)**.
...
```text
Scan name: price consolidation within 1%
Scan id: 4735194
Slug: price-consolidation-within-1
Source URL: https://chartink.com/screener/price-consolidation-within-1
Root universe/segment: cash
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2021-05-30T12:05:03.000000Z
...
3. [Enabled] daily count( 20, 1 where daily abs( ( daily close / 1 day ago close ) - 1 ) < 0.01 ) > 8

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( cash ( 1 day ago close * 1 day ago volume > 100000000 and latest count( 200, 1 where( latest high / latest low ) = 1 ) < 1 and latest count( 20, 1 where abs( ( latest close / 1 day ago close ) - 1 ) < 0.01 ) > 8 ) )
```
...
| 3 | Enabled | daily count( 20, 1 where daily abs( ( daily close / 1 day ago close ) - 1 ) < 0.01 ) > 8 | Inequality test: left expression must be strictly greater than right. |
...
- **#3** `daily count( 20, 1 where daily abs( ( daily close / 1 day ago close ) - 1 ) < 0.01 ) > 8` — Inequality test: left expression must be strictly greater than right.
