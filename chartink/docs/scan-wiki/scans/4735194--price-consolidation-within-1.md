...
- daily count( 20, 1 where daily abs( ( daily close / 1 day ago close ) - 1 ) < 0.01 ) > 8
...
| 3 | 3 | Enabled | root | daily count( 20, 1 where daily abs( ( daily close / 1 day ago close ) - 1 ) < 0.01 ) > 8 | Inequality test: left expression must be strictly greater than right. |
