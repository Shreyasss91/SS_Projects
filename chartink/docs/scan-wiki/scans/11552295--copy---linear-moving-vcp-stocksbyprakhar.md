...
source_url: https://chartink.com/screener/copy-linear-moving-vcp-atstocksbyprakhar-89
...
- Chartink URL: https://chartink.com/screener/copy-linear-moving-vcp-atstocksbyprakhar-89
- Scan ID: `11552295`
- Slug: `copy-linear-moving-vcp-atstocksbyprakhar-89`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-04-23T02:26:41.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/11552295.json](../source-snapshots/11552295.json)
- Text snapshot: [source-snapshots/11552295.txt](../source-snapshots/11552295.txt)
...
https://twitter.com/StocksbyPrakhar/status/1649498460679467008
...
Scan id: 11552295
Slug: copy-linear-moving-vcp-atstocksbyprakhar-89
Source URL: https://chartink.com/screener/copy-linear-moving-vcp-atstocksbyprakhar-89
Root universe/segment: cash
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2023-04-23T02:26:41.000000Z
...
12. [Enabled] daily max( 23 ,  daily high ) / daily min( 23 ,  daily low ) <= 1.20
13. [Enabled] daily max( 5 ,  daily high ) / daily min( 5 ,  daily low ) <= 1.14
...
- **#12** `daily max( 23 ,  daily high ) / daily min( 23 ,  daily low ) <= 1.20` — Inequality test: left expression must be less than or equal to right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars.
- **#13** `daily max( 5 ,  daily high ) / daily min( 5 ,  daily low ) <= 1.14` — Inequality test: left expression must be less than or equal to right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars.
- **#14** `daily max( 3 ,  daily high ) / daily min( 3 ,  daily low ) <= 1.10` — Inequality test: left expression must be less than or equal to right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars.
