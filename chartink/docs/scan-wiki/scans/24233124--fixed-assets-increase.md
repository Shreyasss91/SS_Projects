...
- Chartink URL: https://chartink.com/screener/fixed-assets-increase-2
- Scan ID: `24233124`
...
- Raw snapshot: [source-snapshots/24233124.json](../source-snapshots/24233124.json)
- Text snapshot: [source-snapshots/24233124.txt](../source-snapshots/24233124.txt)

## What this scan is for

This is a **swing** screen over **nifty 500** with **1** active leaf condition(s) under root join **all (AND)**.
...
Scan id: 24233124
Slug: fixed-assets-increase-2
Source URL: https://chartink.com/screener/fixed-assets-increase-2
...
- **#1** `0 years ago fixed assets > 1 years ago fixed assets * 10` — Inequality test: left expression must be strictly greater than right.
...
### Measures observed
- `fixed assets` — appears 2 time(s) in the expression tree
...
- Timeframe tokens: `0_days_ago`, `0_years_ago`, `1_years_ago`
