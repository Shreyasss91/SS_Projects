...
| 2 | 2 | Enabled | root | weekly count streak( 4, 1 where weekly close > 1 week ago close ) >= 4 | Inequality test: left expression must be strictly greater than right. References weekly bars / weekly offset. |
