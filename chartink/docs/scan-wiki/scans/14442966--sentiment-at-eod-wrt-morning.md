...
tags: ["bias:upward-condition", "bias:downward-condition", "universe:nifty-200", "indicator:sma", "timeframe:daily", "timeframe:intraday-bars"]
...
# sentiment at EOD wrt morning

## Source

- Chartink URL: https://chartink.com/screener/sentiment-at-eod-wrt-morning
- Scan ID: `14442966`
- Slug: `sentiment-at-eod-wrt-morning`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2024-01-01T07:41:49.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/14442966.json](../source-snapshots/14442966.json)
- Text snapshot: [source-snapshots/14442966.txt](../source-snapshots/14442966.txt)
...
Scan id: 14442966
Slug: sentiment-at-eod-wrt-morning
Source URL: https://chartink.com/screener/sentiment-at-eod-wrt-morning
...
3. [Enabled] [75] 5 minute sma( close ,  20 ) > [1] 5 minute sma( close ,  20 ) * 3
    group_path: root/group[cash|any]
...
- **#2** `[75] 5 minute sma( close ,  20 ) > [20] 5 minute sma( close ,  20 ) * 3` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#3** `[75] 5 minute sma( close ,  20 ) > [1] 5 minute sma( close ,  20 ) * 3` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#4** `daily % change < 0.25` — Inequality test: left expression must be strictly less than right.
