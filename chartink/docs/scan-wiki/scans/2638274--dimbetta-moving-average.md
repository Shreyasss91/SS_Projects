...
- Chartink URL: https://chartink.com/screener/dimbetta-moving-average
- Scan ID: `2638274`
- Slug: `dimbetta-moving-average`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2020-08-01T07:24:18.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/2638274.json](../source-snapshots/2638274.json)
- Text snapshot: [source-snapshots/2638274.txt](../source-snapshots/2638274.txt)
...
Scan id: 2638274
Slug: dimbetta-moving-average
Source URL: https://chartink.com/screener/dimbetta-moving-average
...
3. [Disabled] daily Dimbetta-dimaVal crossed below -0.08
4. [Disabled] daily Dimbetta-dimaVal < 0
5. [Disabled] daily Dimbetta-dimaVal crossed above daily sma( close ,  150 )
...
- **#2** `daily Dimbetta-dimaVal crossed above 0.25` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar).
...
### Disabled #3
- **Condition (verbatim):** `daily Dimbetta-dimaVal crossed below -0.08`
...
### Disabled #4
- **Condition (verbatim):** `daily Dimbetta-dimaVal < 0`
...
### Disabled #5
- **Condition (verbatim):** `daily Dimbetta-dimaVal crossed above daily sma( close ,  150 )`
...
### Disabled #7
- **Condition (verbatim):** `daily Dimbetta-dimaVal crossed below daily sma( close ,  150 )`
...
### Measures observed
- `custom_indicator_4697` — appears 8 time(s) in the expression tree
