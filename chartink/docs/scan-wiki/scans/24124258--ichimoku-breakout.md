...
tags: ["bias:upward-condition", "universe:nifty-200", "indicator:rsi", "indicator:ichimoku", "timeframe:daily"]
...
This is a **swing** screen over **nifty 200** with **20** active leaf condition(s) under root join **all (AND)**.
