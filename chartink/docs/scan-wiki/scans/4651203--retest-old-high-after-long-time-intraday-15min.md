---
scan_id: 4651203
scan_name: Retest old high after long time intraday 15min
source_url: https://chartink.com/screener/retest-old-high-after-long-time-intraday
...
# Retest old high after long time intraday 15min

## Source

- Chartink URL: https://chartink.com/screener/retest-old-high-after-long-time-intraday
- Scan ID: `4651203`
- Slug: `retest-old-high-after-long-time-intraday`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2021-05-23T14:00:23.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/4651203.json](../source-snapshots/4651203.json)
- Text snapshot: [source-snapshots/4651203.txt](../source-snapshots/4651203.txt)

## What this scan is for

This scan, titled "Retest old high after long time intraday 15min", appears designed to screen Indian equities in the **futures** universe using **4 enabled** condition(s) combined with root join **all (AND)**.
...
```text
Scan name: Retest old high after long time intraday 15min
Scan id: 4651203
Slug: retest-old-high-after-long-time-intraday
Source URL: https://chartink.com/screener/retest-old-high-after-long-time-intraday
Root universe/segment: futures
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2021-05-23T14:00:23.000000Z
...
3. [Enabled] daily high crossed above [-1] 15 minute max( 499 ,  [0] 15 minute high )
4. [Enabled] [-1] 15 minute max( 499 ,  [0] 15 minute high ) < [-500] 15 minute max( 500 ,  [0] 15 minute high )

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( futures ( 1 day ago close * 1 day ago volume > 100000000 and latest count( 200, 1 where( latest high / latest low ) = 1 ) < 1 and latest high > [-1] 15 minute max( 499 , [0] 15 minute high ) and 1 day ago  high <= [ -2 ] 15 minute max( 499 , [0] 15 minute high ) and [-1] 15 minute max( 499 , [0] 15 minute high ) < [-500] 15 minute max( 500 , [0] 15 minute high ) ) )
```
...
| 3 | Enabled | daily high crossed above [-1] 15 minute max( 499 ,  [0] 15 minute high ) | Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 4 | Enabled | [-1] 15 minute max( 499 ,  [0] 15 minute high ) < [-500] 15 minute max( 500 ,  [0] 15 minute high ) | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
...
- **#4** `[-1] 15 minute max( 499 ,  [0] 15 minute high ) < [-500] 15 minute max( 500 ,  [0] 15 minute high )` — Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data.
