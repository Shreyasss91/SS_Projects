...
- 20 weeks ago max( 480 ,  weekly high ) < 500 weeks ago max( 500 ,  weekly high )
- 1 day ago close * 1 day ago volume > 100000000
- daily count( 200, 1 where ( daily high / daily low ) = 1 ) < 1
- weekly high crossed above 1 week ago max( 499 ,  weekly high )
- 1 week ago max( 499 ,  weekly high ) < 500 weeks ago max( 500 ,  weekly high )
...
| 3 | 4 | Enabled | root/group[cash\|all] | weekly high crossed above 20 weeks ago max( 480 ,  weekly high ) | Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset. |
| 4 | 5 | Enabled | root/group[cash\|all] | 20 weeks ago max( 480 ,  weekly high ) < 500 weeks ago max( 500 ,  weekly high ) | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset. |
...
| 7 | 9 | Enabled | root/group[cash\|all] | weekly high crossed above 1 week ago max( 499 ,  weekly high ) | Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset. |
| 8 | 10 | Enabled | root/group[cash\|all] | 1 week ago max( 499 ,  weekly high ) < 500 weeks ago max( 500 ,  weekly high ) | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset. |
