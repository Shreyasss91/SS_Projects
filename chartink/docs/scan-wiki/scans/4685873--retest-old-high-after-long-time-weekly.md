...
tags: ["long-bias", "universe:cash", "indicator:volume", "timeframe:weekly", "timeframe:daily"]
...
# Retest old high after long time weekly

## Source

- Chartink URL: https://chartink.com/screener/retest-old-high-after-long-time-weekly
- Scan ID: `4685873`
- Slug: `retest-old-high-after-long-time-weekly`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2021-05-26T11:20:28.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/4685873.json](../source-snapshots/4685873.json)
- Text snapshot: [source-snapshots/4685873.txt](../source-snapshots/4685873.txt)

## What this scan is for

This scan, titled "Retest old high after long time weekly", appears designed to screen Indian equities in the **cash** universe using **8 enabled** condition(s) combined with root join **any (OR)**.
...
Observed Chartink timeframe offsets in the tree: `0_days_ago, 0_weeks_ago, 1_days_ago, 1_weeks_ago, 20_weeks_ago, 21_days_ago, 500_weeks_ago`.
...
```text
Scan name: Retest old high after long time weekly
Scan id: 4685873
Slug: retest-old-high-after-long-time-weekly
Source URL: https://chartink.com/screener/retest-old-high-after-long-time-weekly
Root universe/segment: cash
Root join: any (OR)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2021-05-26T11:20:28.000000Z
...
3. [Enabled] daily count( 200, 1 where ( daily high / daily low ) = 1 ) < 1
    group_path: root/group[cash|all]
4. [Enabled] weekly high crossed above 20 weeks ago max( 480 ,  weekly high )
    group_path: root/group[cash|all]
5. [Enabled] 20 weeks ago max( 480 ,  weekly high ) < 500 weeks ago max( 500 ,  weekly high )
    group_path: root/group[cash|all]
...
8. [Enabled] daily count( 200, 1 where ( daily high / daily low ) = 1 ) < 1
    group_path: root/group[cash|all]
9. [Enabled] weekly high crossed above 1 week ago max( 499 ,  weekly high )
    group_path: root/group[cash|all]
10. [Enabled] 1 week ago max( 499 ,  weekly high ) < 500 weeks ago max( 500 ,  weekly high )
    group_path: root/group[cash|all]

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( cash ( ( cash ( 1 day ago close * 1 day ago volume > 100000000 and latest count( 200, 1 where( latest high / latest low ) = 1 ) < 1 and weekly high > 20 weeks ago max( 480 , weekly high ) and 1 week ago  high <= 21 weeks ago  max( 480 , weekly high ) and 20 weeks ago max( 480 , weekly high ) < 500 weeks ago max( 500 , weekly high ) ) ) or( cash ( 1 day ago close * 1 day ago volume > 100000000 and latest count( 200, 1 where( latest high / latest low ) = 1 ) < 1 and weekly high > 1 week ago max( 499 , weekly high ) and 1 week ago  high <= 2 week ago  max( 499 , weekly high ) and 1 week ago max( 499 , weekly high ) < 500 weeks ago max( 500 , weekly high ) ) ) ) )
```
...
| 4 | Enabled | weekly high crossed above 20 weeks ago max( 480 ,  weekly high ) | Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset. |
| 5 | Enabled | 20 weeks ago max( 480 ,  weekly high ) < 500 weeks ago max( 500 ,  weekly high ) | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset. |
...
| 9 | Enabled | weekly high crossed above 1 week ago max( 499 ,  weekly high ) | Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset. |
| 10 | Enabled | 1 week ago max( 499 ,  weekly high ) < 500 weeks ago max( 500 ,  weekly high ) | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset. |
...
- **#4** `weekly high crossed above 20 weeks ago max( 480 ,  weekly high )` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset.
- **#5** `20 weeks ago max( 480 ,  weekly high ) < 500 weeks ago max( 500 ,  weekly high )` — Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset.
...
- **#9** `weekly high crossed above 1 week ago max( 499 ,  weekly high )` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset.
- **#10** `1 week ago max( 499 ,  weekly high ) < 500 weeks ago max( 500 ,  weekly high )` — Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset.
...
- Timeframe tokens: `0_days_ago`, `0_weeks_ago`, `1_days_ago`, `1_weeks_ago`, `20_weeks_ago`, `21_days_ago`, `500_weeks_ago`
