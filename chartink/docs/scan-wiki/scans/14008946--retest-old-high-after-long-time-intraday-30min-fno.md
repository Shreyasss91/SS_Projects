...
- [-1] 30 minute max( 499 ,  [0] 30 minute close ) < [-500] 30 minute max( 500 ,  [0] 30 minute close )
...
| 4 | 4 | Enabled | root | [-1] 30 minute max( 499 ,  [0] 30 minute close ) < [-500] 30 minute max( 500 ,  [0] 30 minute close ) | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
