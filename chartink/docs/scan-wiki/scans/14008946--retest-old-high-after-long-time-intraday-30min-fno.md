...
# Retest old high after long time intraday 30min FNO

## Source

- Chartink URL: https://chartink.com/screener/retest-old-high-after-long-time-intraday-30min-fno
- Scan ID: `14008946`
- Slug: `retest-old-high-after-long-time-intraday-30min-fno`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2023-11-30T14:03:23.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/14008946.json](../source-snapshots/14008946.json)
- Text snapshot: [source-snapshots/14008946.txt](../source-snapshots/14008946.txt)

## What this scan is for

This scan, titled "Retest old high after long time intraday 30min FNO", appears designed to screen Indian equities in the **futures** universe using **4 enabled** condition(s) combined with root join **all (AND)**.
...
```text
Scan name: Retest old high after long time intraday 30min FNO
Scan id: 14008946
Slug: retest-old-high-after-long-time-intraday-30min-fno
Source URL: https://chartink.com/screener/retest-old-high-after-long-time-intraday-30min-fno
Root universe/segment: futures
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2023-11-30T14:03:23.000000Z
...
3. [Enabled] [0] 30 minute high crossed above [-1] 30 minute max( 499 ,  [0] 30 minute close )
4. [Enabled] [-1] 30 minute max( 499 ,  [0] 30 minute close ) < [-500] 30 minute max( 500 ,  [0] 30 minute close )

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( futures ( 1 day ago close * 1 day ago volume > 100000000 and latest count( 200, 1 where( latest high / latest low ) = 1 ) < 1 and [0] 30 minute high > [-1] 30 minute max( 499 , [0] 30 minute close ) and [ -1 ] 30 minute high <= [ -2 ] 30 minute max( 499 , [0] 30 minute close ) and [-1] 30 minute max( 499 , [0] 30 minute close ) < [-500] 30 minute max( 500 , [0] 30 minute close ) ) )
```
...
| 3 | Enabled | [0] 30 minute high crossed above [-1] 30 minute max( 499 ,  [0] 30 minute close ) | Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 4 | Enabled | [-1] 30 minute max( 499 ,  [0] 30 minute close ) < [-500] 30 minute max( 500 ,  [0] 30 minute close ) | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
...
- **#4** `[-1] 30 minute max( 499 ,  [0] 30 minute close ) < [-500] 30 minute max( 500 ,  [0] 30 minute close )` — Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data.
