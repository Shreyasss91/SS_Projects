...
tags: ["bias:upward-condition", "bias:downward-condition", "universe:11", "indicator:mfi", "indicator:volume", "indicator:sma", "timeframe:daily"]
...
This is a **swing** screen over **11** with **6** active leaf condition(s) under root join **any (OR)**.
