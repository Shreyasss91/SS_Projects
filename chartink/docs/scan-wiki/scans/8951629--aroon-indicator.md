...
- Chartink URL: https://chartink.com/screener/aroon-osc-171
- Scan ID: `8951629`
- Slug: `aroon-osc-171`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2022-07-05T15:56:23.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/8951629.json](../source-snapshots/8951629.json)
- Text snapshot: [source-snapshots/8951629.txt](../source-snapshots/8951629.txt)
...
Scan id: 8951629
Slug: aroon-osc-171
Source URL: https://chartink.com/screener/aroon-osc-171
...
3. [Enabled] [0] 5 minute aroon up( 500 ) crossed above [0] 5 minute aroon down( 500 )
    group_path: root/group[cash|all]
4. [Enabled] [0] 5 minute aroon down( 500 ) crossed above [0] 5 minute aroon up( 500 )
    group_path: root/group[cash|all]
5. [Disabled] [GROUP segment=cash join=all combination=passes measurevalue=default]  (path: root/group[cash|all])
6. [Enabled] [0] 5 minute aroon up( 500 ) - [-6] 5 minute aroon up( 500 ) crossed above 80
    group_path: root/group[cash|all]
7. [Disabled] [0] 5 minute aroon down( 500 ) - [-6] 5 minute aroon down( 500 ) crossed above 75
    group_path: root/group[cash|all]
8. [Enabled] [0] 5 minute aroon up( 500 ) - [-1] 5 minute aroon up( 500 ) crossed above 20
    group_path: root/group[cash|all]
9. [Disabled] [0] 5 minute aroon down( 500 ) - [-1] 5 minute aroon down( 500 ) crossed above 20
    group_path: root/group[cash|all]
10. [Enabled] [GROUP segment=cash join=all combination=passes measurevalue=default]  (path: root/group[cash|all])
11. [Disabled] [0] 5 minute count( 225, 1 where [0] 5 minute aroon up( 500 ) > 90 ) crossed above 210
    group_path: root/group[cash|all]
12. [Disabled] [0] 5 minute count( 225, 1 where [0] 5 minute aroon down( 500 ) - [-1] 5 minute aroon down( 500 ) < 0 ) = 225
    group_path: root/group[cash|all]
13. [Enabled] [0] 5 minute count( 75, 1 where [0] 5 minute aroon down( 500 ) > 90 ) crossed above 65
    group_path: root/group[cash|all]
...
- **#3** `[0] 5 minute aroon up( 500 ) crossed above [0] 5 minute aroon down( 500 )` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#4** `[0] 5 minute aroon down( 500 ) crossed above [0] 5 minute aroon up( 500 )` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#6** `[0] 5 minute aroon up( 500 ) - [-6] 5 minute aroon up( 500 ) crossed above 80` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#8** `[0] 5 minute aroon up( 500 ) - [-1] 5 minute aroon up( 500 ) crossed above 20` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#13** `[0] 5 minute count( 75, 1 where [0] 5 minute aroon down( 500 ) > 90 ) crossed above 65` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#14** `[0] 5 minute count( 150, 1 where [0] 5 minute aroon up( 500 ) - [-1] 5 minute aroon up( 500 ) < 0 ) = 150` — Inequality test: left expression must be strictly less than right. Uses an intraday bar size (minute timeframe) rather than daily-only data.
...
### Disabled #7
- **Condition (verbatim):** `[0] 5 minute aroon down( 500 ) - [-6] 5 minute aroon down( 500 ) crossed above 75`
...
### Disabled #9
- **Condition (verbatim):** `[0] 5 minute aroon down( 500 ) - [-1] 5 minute aroon down( 500 ) crossed above 20`
- **Meaning:** Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). Currently disabled in source — not applied when the scan runs. Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **If enabled:** would add this constraint to the active boolean tree (subject to its group join), likely changing candidate count and timing.
- **Trade-offs:** enabling usually increases selectivity and may remove early or noisy matches; keeping it disabled preserves a wider (or differently timed) set of results.

### Disabled #11
- **Condition (verbatim):** `[0] 5 minute count( 225, 1 where [0] 5 minute aroon up( 500 ) > 90 ) crossed above 210`
- **Meaning:** Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). Currently disabled in source — not applied when the scan runs. Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **If enabled:** would add this constraint to the active boolean tree (subject to its group join), likely changing candidate count and timing.
- **Trade-offs:** enabling usually increases selectivity and may remove early or noisy matches; keeping it disabled preserves a wider (or differently timed) set of results.

### Disabled #12
- **Condition (verbatim):** `[0] 5 minute count( 225, 1 where [0] 5 minute aroon down( 500 ) - [-1] 5 minute aroon down( 500 ) < 0 ) = 225`
...
### Measures observed
- `aroon up` — appears 9 time(s) in the expression tree
- `aroon down` — appears 9 time(s) in the expression tree
