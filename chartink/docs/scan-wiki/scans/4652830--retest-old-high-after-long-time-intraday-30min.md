...
- daily high crossed above [-1] 30 minute max( 499 ,  [0] 30 minute high )
- [-1] 30 minute max( 499 ,  [0] 30 minute high ) < [-500] 30 minute max( 500 ,  [0] 30 minute high )
...
| 3 | 3 | Enabled | root | daily high crossed above [-1] 30 minute max( 499 ,  [0] 30 minute high ) | Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
| 4 | 4 | Enabled | root | [-1] 30 minute max( 499 ,  [0] 30 minute high ) < [-500] 30 minute max( 500 ,  [0] 30 minute high ) | Inequality test: left expression must be strictly less than right. max(N, series) is the highest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data. |
