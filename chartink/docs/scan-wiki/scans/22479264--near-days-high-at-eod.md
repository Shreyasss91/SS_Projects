...
# Near days HIGH at EOD

## Source

- Chartink URL: https://chartink.com/screener/near-days-high-at-eod
- Scan ID: `22479264`
- Slug: `near-days-high-at-eod`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2025-06-20T13:02:25.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/22479264.json](../source-snapshots/22479264.json)
- Text snapshot: [source-snapshots/22479264.txt](../source-snapshots/22479264.txt)
...
Scan id: 22479264
Slug: near-days-high-at-eod
Source URL: https://chartink.com/screener/near-days-high-at-eod
...
- **#1** `[5] 75 minute high crossed above [-1] 75 minute max( 4 ,  [0] 75 minute high )` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). max(N, series) is the highest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#3** `[1] 75 minute high > [-1] 75 minute max( 3 ,  [0] 75 minute high )` — Inequality test: left expression must be strictly greater than right. max(N, series) is the highest value of series over N bars. Uses an intraday bar size (minute timeframe) rather than daily-only data.
