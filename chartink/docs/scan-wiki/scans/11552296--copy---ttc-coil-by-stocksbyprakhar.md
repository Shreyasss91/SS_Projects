...
This scan, titled "Copy - TTC COIL by @Stocksbyprakhar", appears designed to screen Indian equities in the **cash** universe using **18 enabled** condition(s) combined with root join **all (AND)**.
...
Observed Chartink timeframe offsets in the tree: `0_days_ago, 0_weeks_ago, 1_days_ago, 2_days_ago, 3_days_ago`.
...
|---:|---|---|---|
| 1 | Enabled | daily high < 3 days ago high | Inequality test: left expression must be strictly less than right. |
| 2 | Enabled | daily low > 3 days ago low | Inequality test: left expression must be strictly greater than right. |
| 3 | Enabled | 1 day ago high < 3 days ago high | Inequality test: left expression must be strictly less than right. |
| 4 | Enabled | 1 day ago low > 3 days ago low | Inequality test: left expression must be strictly greater than right. |
| 5 | Enabled | 2 days ago high < 3 days ago high | Inequality test: left expression must be strictly less than right. |
| 6 | Enabled | 2 days ago low > 3 days ago low | Inequality test: left expression must be strictly greater than right. |
| 7 | Enabled | daily close > daily sma( close ,  50 ) | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. |
| 8 | Enabled | ( daily close - daily sma( close ,  50 ) / daily sma( close ,  50 ) ) < 0.16 | Inequality test: left expression must be strictly less than right. SMA is the arithmetic mean of the chosen field over N bars. |
| 9 | Enabled | daily sma( close,50 ) > daily sma( close,150 ) | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. |
| 10 | Enabled | daily close > daily sma( close,150 ) | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. |
| 11 | Enabled | daily close > daily sma( close,200 ) | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. |
| 12 | Enabled | daily sma( close,150 ) > daily sma( close,200 ) | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. |
| 13 | Enabled | daily sma( close,50 ) > daily sma( close,200 ) | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. |
| 14 | Enabled | daily close > weekly max( 52 ,  weekly high ) * 0.75 | Inequality test: left expression must be strictly greater than right. max(N, series) is the highest value of series over N bars. References weekly bars / weekly offset. |
| 15 | Enabled | daily volume > 5000 | Inequality test: left expression must be strictly greater than right. Volume condition gates participation/liquidity. |
| 16 | Enabled | daily market cap <= 40000 | Inequality test: left expression must be less than or equal to right. Filters by market-capitalisation field from Chartink fundamentals. |
| 17 | Enabled | daily max( 23 ,  daily high ) / daily min( 23 ,  daily low ) <= 1.20 | Inequality test: left expression must be less than or equal to right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars. |
| 18 | Enabled | daily max( 5 ,  daily high ) / daily min( 5 ,  daily low ) <= 1.14 | Inequality test: left expression must be less than or equal to right. max(N, series) is the highest value of series over N bars. min(N, series) is the lowest value of series over N bars. |
