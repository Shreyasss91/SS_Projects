...
- Chartink URL: https://chartink.com/screener/price-change-long-term
- Scan ID: `4704687`
- Slug: `price-change-long-term`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Intraday
- Created at (Chartink): 2021-05-27T20:00:28.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/4704687.json](../source-snapshots/4704687.json)
- Text snapshot: [source-snapshots/4704687.txt](../source-snapshots/4704687.txt)
...
Scan id: 4704687
Slug: price-change-long-term
Source URL: https://chartink.com/screener/price-change-long-term
...
- **#2** `[0] 1 minute sum( close ,  4500 ) crossed below 0` — Requires a bearish crossover event (left series moves from at/above to below the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data.
- **#3** `[0] 15 minute sum( close ,  300 ) crossed above 3` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). Uses an intraday bar size (minute timeframe) rather than daily-only data.
