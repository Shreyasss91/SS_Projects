...
- Chartink URL: https://chartink.com/screener/basic-filter-190229
- Scan ID: `11634168`
- Slug: `basic-filter-190229`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-05-02T11:18:29.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/11634168.json](../source-snapshots/11634168.json)
- Text snapshot: [source-snapshots/11634168.txt](../source-snapshots/11634168.txt)

## What this scan is for

This scan, titled "BASIC FILTER", appears designed to screen Indian equities in the **cash** universe using **3 enabled** condition(s) combined with root join **all (AND)**.
...
```text
Scan name: BASIC FILTER
Scan id: 11634168
Slug: basic-filter-190229
Source URL: https://chartink.com/screener/basic-filter-190229
Root universe/segment: cash
Root join: all (AND)
Root combination: passes
Root measurevalue: default
is_private: False
created_at: 2023-05-02T11:18:29.000000Z

=== Condition tree (from atlas_json; includes Enabled and Disabled) ===

1. [Enabled] 1 day ago close * 1 day ago volume > 1000000000
2. [Enabled] ( daily avg true range( 7 ) / daily sma( close ,  7 ) ) * 100 > 3
3. [Enabled] daily close > 50

=== Chartink atlas_query (compiled/active form; typically omits disabled filters) ===

( cash ( 1 day ago close * 1 day ago volume > 1000000000 and( latest avg true range( 7 ) / latest sma( latest close , 7 ) ) * 100 > 3 and latest close > 50 ) )
```
...
| 2 | Enabled | ( daily avg true range( 7 ) / daily sma( close ,  7 ) ) * 100 > 3 | Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. ATR measures smoothed true range (volatility), not direction. |
...
- **#2** `( daily avg true range( 7 ) / daily sma( close ,  7 ) ) * 100 > 3` — Inequality test: left expression must be strictly greater than right. SMA is the arithmetic mean of the chosen field over N bars. ATR measures smoothed true range (volatility), not direction.
