...
horizon: Swing
classification: ["Moving average", "Oscillator", "Momentum", "Trend following", "Multi-factor"]
tags: ["bias:upward-condition", "universe:futures", "indicator:rsi", "indicator:sma", "timeframe:daily"]
...
- Chartink URL: https://chartink.com/screener/rsi-breakout-871
- Scan ID: `14108251`
- Slug: `rsi-breakout-871`
- Captured: 2026-07-15T12:56:06+05:30
- Market: Indian equities
- Intended horizon: Swing
- Created at (Chartink): 2023-12-08T02:10:22.000000Z
- Private: False
- Favourite flag: 0
- Alert present flag: 0
- Raw snapshot: [source-snapshots/14108251.json](../source-snapshots/14108251.json)
- Text snapshot: [source-snapshots/14108251.txt](../source-snapshots/14108251.txt)

## What this scan is for

This is a **swing** screen over **futures** with **3** active leaf condition(s) under root join **all (AND)**.
Its method labels are derived only from active expressions: **Moving average, Oscillator, Momentum, Trend following, Multi-factor**.
...
Scan id: 14108251
Slug: rsi-breakout-871
Source URL: https://chartink.com/screener/rsi-breakout-871
...
- **#1** `daily rsi( 14 ) crossed above 1 day ago max( 20 ,  daily rsi( 14 ) )` — Requires a bullish crossover event (left series moves from at/below to above the right series on the selected bar). RSI is a momentum oscillator from average gains/losses over its period. max(N, series) is the highest value of series over N bars.
- **#2** `daily rsi( 14 ) > daily sma( close ,  20 )` — Inequality test: left expression must be strictly greater than right. RSI is a momentum oscillator from average gains/losses over its period. SMA is the arithmetic mean of the chosen field over N bars.
- **#3** `daily rsi( 14 ) - 7 days ago rsi( 14 ) > 10` — Inequality test: left expression must be strictly greater than right. RSI is a momentum oscillator from average gains/losses over its period.
...
- Timeframe tokens: `0_days_ago`, `1_days_ago`, `7_days_ago`
...
- **Method context:** Moving average, Oscillator, Momentum, Trend following, Multi-factor.
...
- **Horizon:** Swing
- **Methods:** Moving average, Oscillator, Momentum, Trend following, Multi-factor
- **Tags:** bias:upward-condition, universe:futures, indicator:rsi, indicator:sma, timeframe:daily
